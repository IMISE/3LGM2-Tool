...
![ICON_LARGE_ACTION_NEW_MODEL.gif](https://bitbucket.org/repo/9L6rMz/images/3556053824-ICON_LARGE_ACTION_NEW_MODEL.gif) **Create New Model**
...
![ICON_LARGE_ACTION_OPEN_MODEL.gif](https://bitbucket.org/repo/9L6rMz/images/3946376882-ICON_LARGE_ACTION_OPEN_MODEL.gif) **Open model**
...
![ICON_LARGE_ACTION_SAVE_MODEL.gif](https://bitbucket.org/repo/9L6rMz/images/3376405419-ICON_LARGE_ACTION_SAVE_MODEL.gif) **Save Model**

Use this button to save your changes to a model. If you have opened a new model that has not yet been saved, a dialog will appear in which you can select a directory for the file to be saved and enter the name of the file. Saved 3LGM² models usually have the extension .3lgm. If your new model has already been saved to a file or if you have opened an existing file, the current state of the model is saved to this file when you click the Save Model button.
 
![ICON_LARGE_ACTION_UNDO.gif](https://bitbucket.org/repo/9L6rMz/images/2043278333-ICON_LARGE_ACTION_UNDO.gif) **Undo**

Use this button to undo the last changes made to your model.
 
![ICON_LARGE_ACTION_REDO.gif](https://bitbucket.org/repo/9L6rMz/images/4259206325-ICON_LARGE_ACTION_REDO.gif) **Redo**

Use this button to restore the last undone changes.
 
![ICON_LARGE_ACTION_GRAPH_SHOW_SINGLE_LAYER_PERSPECTIVE.gif](https://bitbucket.org/repo/9L6rMz/images/3088995828-ICON_LARGE_ACTION_GRAPH_SHOW_SINGLE_LAYER_PERSPECTIVE.gif) / ![ICON_LARGE_ACTION_GRAPH_SHOW_THREE_LAYER_PERSPECTIVE.gif](https://bitbucket.org/repo/9L6rMz/images/3317896394-ICON_LARGE_ACTION_GRAPH_SHOW_THREE_LAYER_PERSPECTIVE.gif) **MultiView**
...
![ICON_LARGE_ACTION_ACTIVATE_DOMAIN_LAYER.gif](https://bitbucket.org/repo/9L6rMz/images/1394051159-ICON_LARGE_ACTION_ACTIVATE_DOMAIN_LAYER.gif) **Domain Layer**

Selects the domain layer.
 
![ICON_LARGE_ACTION_ACTIVATE_LOGICAL_LAYER.gif](https://bitbucket.org/repo/9L6rMz/images/1999977732-ICON_LARGE_ACTION_ACTIVATE_LOGICAL_LAYER.gif) **Logical tool layer**

Selects the logical tool layer.
 
![ICON_LARGE_ACTION_ACTIVATE_PHYSICAL_LAYER.gif](https://bitbucket.org/repo/9L6rMz/images/4010710787-ICON_LARGE_ACTION_ACTIVATE_PHYSICAL_LAYER.gif) **Physical tool layer**

Selects the physical tool layer.

![ICON_LARGE_ACTION_GOTO_PREVIOUS_VIEW.gif](https://bitbucket.org/repo/9L6rMz/images/2507821222-ICON_LARGE_ACTION_GOTO_PREVIOUS_VIEW.gif) **Previous window**

Switches view to previous window.

![ICON_LARGE_ACTION_GOTO_NEXT_VIEW.gif](https://bitbucket.org/repo/9L6rMz/images/1956595181-ICON_LARGE_ACTION_GOTO_NEXT_VIEW.gif) **Next window**

Switches view to next window.