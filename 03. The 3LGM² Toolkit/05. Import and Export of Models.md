...
If a model is displayed in the document window, you can export it as a graphic. After selecting *File > Export... > Export as Graphic...*, a dialog box appears in which you can give the file to be exported a name and select a directory. Under File type, you can select the file type of the graphic file. You can also select the resolution the graphic file. By clicking on Save, the file is exported.
...
![xlst.PNG](https://bitbucket.org/repo/9L6rMz/images/1318575659-xlst.PNG)
...
|----------------|-----------------|--------------|
| [Analysis of 3LGM² models](04. Analysis of 3LGM² models) | [The 3LGM² Toolkit](https://bitbucket.org/imise/tool-3lgm2/wiki/03.%20The%203LGM%C2%B2%20Toolkit) | [Import and Export of Models](06. Userfields and Subtypes) |
