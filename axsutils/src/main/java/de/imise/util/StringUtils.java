...
public class StringUtils {
	 ...
	 *            Wenn <code>true</code> wird der <code>text2Find</code> als regulärer Ausdruck interpretiert, bei <code>false</code> wird er immer im Original gesucht.
	 * @param wholeWord
	 *            Wenn <code>true</code> muss der zu suchende String als ganzes Wort gefunden werden. Das ist der Fall wenn der gefundene Textteil von Whitespaces, Zeilenumbrüchen oder dem
	 *            Stringanfang oder - ende eingerahmt ist.
	 * @param wrapSearch
	 *            Wenn <code>false</code> endet die Suche (je nach Suchrichtung) am Anfang oder Ende des zu durchsuchenden Strings. Bei <code>true</code> wird die Suche (je nach Suchrichtung) dann
	 *            wieder am Ende bzw. Anfang forgesetzt.
	 * @return Position und Länge des gefundenen Suchstrings im zu duerchsuchenden Text oder <code>null</code>, wenn der Suchstring nicht gefunden wurde. Die zurück gegebene Länge kann sich von der
	 *         Länge des <code>text2Find</code> unterscheiden, wenn mit regulären Ausdrücken gesucht wird.
	 *         
	 *         
	 *         
	 */
	public static final IntRange find(String text, String text2Find, int fromIndex, boolean ignoreCase, boolean searchForward, boolean text2FindAsRegExp, boolean wholeWord, boolean wrapSearch) {
