...
//TODO:AXS (29.07.07): dasselbe stellt mittlerweile java.awt.Desktop bereit (-> raus hiermit)
/**
...
public class BrowserLauncher {
	 ...
	 * If an error occurs, this value will be unequal null.
	 */
	...
	static {
		...
		if (errorMessage==null) {	// if we haven't hit any errors yet
			loadClasses();
		}
	}
	/**
	 ...
	 *			open the default web browser.  In some cases, this will be a non-String modelElement
