...
public class ScreenRobot {
	 ...
	 * @param y
	 */
	public static final void setMouse(int x, int y){
		robot.mouseMove(x, y);
	}
	/**
	 * @param p
	 */
	public static final void setMouse(Point p){
	 ...
	 * @param tolerance
	 */
	public static final void setMouse(Point p, int tolerance){
	 ...
	 * @return
	 */
	public static final BufferedImage getScreenShot(int x, int y, int w, int h){
	 ...
	 * @return
	 */
	public static final Color getScreenColor(Pixel p){
	 ...
	 * @return
	 */
	public static final Color getScreenColor(Point p){
		return getScreenColor(p.x, p.y);
	}
	 ...
	 * @return
	 */
	public static final Color getScreenColor(int x, int y){
	 ...
	 * 		KeyEvent id
	 */
	public static void pressKey(int mask) {
		robot.keyPress(mask);
		delay();
	 ...
	 * 		KeyEvent id
	 */
	public static void pressKey(int mask1, int mask2) {
	 ...
	 * 		KeyEvent id
	 */
	public static void pressKey(int mask1, int mask2, int mask3) {
		robot.keyPress(mask1);
		delay();
	 ...
	 */
	public static final void setStandardDelay(int standardDelay) {
