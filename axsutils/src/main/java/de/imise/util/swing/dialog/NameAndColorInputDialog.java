...
public class NameAndColorInputDialog extends JDialog implements ActionListener {
	 ...
	 * @param owner
	 */
	public NameAndColorInputDialog(JFrame owner) {
		super(owner);
		init();
	}
	 ...
	 * @param owner
	 */
	public NameAndColorInputDialog(JDialog owner) {
		super(owner);
		init();
	}
	 ...
	 */
	public void showDialog(String title, String defaultString, int x, int y, int width, int height, boolean showColorChooser) {
		setTitle(title);
	 ...
	 * @param showColorChooser
	 */
	public void showDialog(String title, String defaultString, int x, int y, boolean showColorChooser) {
	 ...
	 * @param showColorChooser
	 */
	public void showDialog(String title, String defaultString, boolean showColorChooser) {
	 ...
	 * @param y
	 */
	public void showDialog(String title, String defaultString, int x, int y) {
	 ...
	 * @param defaultString
	 */
	public void showDialog(String title, String defaultString) {
