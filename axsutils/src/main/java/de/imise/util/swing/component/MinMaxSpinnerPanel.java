...
/**
 * Ein Panel, das 2 Spinner anzeigt, wobei das eine immer einen kleineren Wert
 * hat, als das andere.
 *
 * @author AFranz
 */
public class MinMaxSpinnerPanel extends JPanel implements ChangeListener {
     ...
     */
    private final RaiseStepSpinner minSpinner, maxSpinner;

    /**
     * Name der Variablen, die zwischen den Kleiner-Gleich-Zeichen angezeigt
     * wird.
     */
    ...
    /**
     * Liefert ein {@link MinMaxSpinnerPanel} für Integer-Werte, bei dem der
     * Minimumspinner mit dem Minimalwert und der Maximumspinner mit dem
     * Maximalwert initialisiert wird.
     * 
     * @param varName
     * @param min
     * @param max
     */
    public MinMaxSpinnerPanel(final String varName, final int min, final int max) {
        this(varName, min, max, min, max);
    }

    /**
     * Liefert ein {@link MinMaxSpinnerPanel} für Integer-Werte, bei dem der
     * Minimumspinner mit dem übergebenen Minimalwert und der Maximumspinner mit
     * dem übergebenen Maximalwert initialisiert wird.
     * 
     * @param varName
     * @param min
     * @param max
     ...
     */
    public MinMaxSpinnerPanel(final String varName, final int min, final int max, final int minInitialValue, final int maxInitialValue) {
        this(varName, min, max, minInitialValue, maxInitialValue, 0);
    }

    /**
     * Liefert ein {@link MinMaxSpinnerPanel} für Double-Werte, bei dem der
     * Minimumspinner mit dem Minimalwert und der Maximumspinner mit dem
     * Maximalwert initialisiert wird.
     * 
     * @param varName
     ...
     * @param decimalPlace
     */
    public MinMaxSpinnerPanel(final String varName, final double min, final double max, final int decimalPlace) {
        this(varName, min, max, min, max, decimalPlace);
    }

    /**
     * Liefert ein {@link MinMaxSpinnerPanel} für Double oder Integer-Werte, bei
     * dem der Minimumspinner mit dem übergebenen Minimalwert und der
     * Maximumspinner mit dem übergebenen Maximalwert initialisiert wird.
     * 
     * @param varName
     * @param min
     * @param max
     ...
     */
    public MinMaxSpinnerPanel(final String varName, final double min, final double max, final double minInitialValue, final double maxInitialValue, final int decimalPlace) {
        super();
    ...
    /**
     * @return Name der Variablen, die zwischen den Kleiner-Gleich-Zeichen
     *         angezeigt wird.
     */
    ...
    /**
     * Setzt den Namen der Variablen, die zwischen den Kleiner-Gleich-Zeichen
     * angezeigt wird.
     *
     * @param varName
     */
    ...
    /**
     * @return Aktuellen Wert des Spinners mit dem Minimumwert.
     */
    ...
    /**
     * @return Aktuellen Wert des Spinners mit dem Maximumwert.
     */
