...
public class SimpleXMLEditor extends JDialog implements ActionListener, ConfirmDialog {
    ...
    JButton okButton;
    /**
     * Knopf zum Abbrechen des Dialoges. Die Variable Auswahl wird auf ABBRECHEN
     * gesetzt.
     */
    JButton cancelButton;
    /**
     * Nach dem Schließen des Dialoges sieht man hier mit welcher Option (OK
     * oder ABBRECHEN) der Dialog geschlossen wurde.
     */
    int auswahl = 0;
