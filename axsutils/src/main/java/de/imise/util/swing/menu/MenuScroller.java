...
public class MenuScroller {
    ...
    private void refreshMenu() {
        ...
        if (topFixedCount > 0 && !(menuItems[topFixedCount - 1] instanceof JSeparator)) {
    ...
    private class MenuScrollListener implements MenuListener, PopupMenuListener {
        ...
        /*
         * (non-Javadoc)
         * @see javax.swing.event.MenuListener#menuSelected(javax.swing.event.
         * MenuEvent)
         */
        @Override
        ...
        /*
         * (non-Javadoc)
         * @see javax.swing.event.MenuListener#menuCanceled(javax.swing.event.
         * MenuEvent)
         */
        @Override
