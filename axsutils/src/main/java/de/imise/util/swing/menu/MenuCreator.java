...
public class MenuCreator {
	 ...
	 *            siehe Klassen-Doku
	 */
	public static final Component[] createMenuEntries(boolean setMnemonics, Object... menuEntries) {
	...
	public static final Component[] createMenuEntries(Object[] menuEntries, boolean setMnemonics) {
		Component[] menuItems = new Component[menuEntries.length];
		Component item;
		for (int i = 0; i < menuEntries.length; i++) {
			item = createMenuEntry(menuEntries[i]);
			if (item != null) {
				menuItems[i] = item;
			}
		}
	 ...
	 *            siehe Klassen-Doku
	 */
	public static final Component createMenuEntry(Object entry) {
	 ...
	 * @param a
	 */
	public static final JCheckBoxMenuItem createCheckBoxMenuItem(Action a) {
	 ...
	 * @param a
	 */
	public static final JRadioButtonMenuItem createRadioButtonMenuItem(Action a) {
	 ...
	 *            siehe Klassen-Doku
	 */
	public static final JMenu createMenu(String title, Object... menuEntries) {
	 ...
	 *            siehe Klassen-Doku
	 */
	public final static void setMnemonics(Component... menuEntries) {
		for (int i = 0; i < menuEntries.length; i++) {
	 ...
	 * @param menu
	 */
	public static JMenuItem[] getAllItems(JMenu menu) {
	 ...
	 * @param menu
	 */
	public static JMenuItem[] getAllItems(JPopupMenu menu) {
		ArrayList<JMenuItem> itemList = new ArrayList<JMenuItem>(menu.getComponentCount());
