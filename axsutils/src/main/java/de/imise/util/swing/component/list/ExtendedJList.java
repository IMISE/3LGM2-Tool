...
public class ExtendedJList extends JList implements CellEditorListener, ListDataListener {
    ...
    /** Editor der Zellen */
    private final ListCellEditor cellEditor;
    ...
    /**
     * @param model Modell der Werte für die Liste
     * @param editor Editor für das Ändern der Werte
     */
    public ExtendedJList(final EditableListModel model, final ListCellEditor editor) {
        super(model);
    ...
    /**
     * Setzt die Höhe der Zellen entsprechend der Werte von
     * {@link CellHeightModel#getHeight(int)}
     *
     * @param cellHeightModel
     */
    public void setCellHeightModel(final CellHeightModel cellHeightModel) {
     ...
     * @return
     */
    public int getCellHeight(final int index, final boolean includeMargin) {
    ...
    protected void processMouseEvent(final MouseEvent e) {
        ...
        /*
         * Erneutes Senden des MouseEvents an die Editorkomponente, da diese
         * beim ersten Eingang des Events zunächst erst initialisiert wird
         */
    ...
    /**
     * Die {@link ExtendedJList} ist nur für die {@link JList#VERTICAL} Layout
     * Orienation definiert.
     */
    @Override
    @Deprecated
     ...
     * @return
     */
    public boolean editCellAt(final int index) {
     ...
     * <p>
     * Der neue Wert wird ins Modell übernommen und der Editor von der Zelle
     * gelöst.
     */
    @Override
    ...
    /**
     * Gibt die in dieser {@link ExtendedJList} dargestellte grafische
     * Komponente des aktuellen Editors wieder.
     *
    ...
    /**
     * Gibt den Abstand zwischen der Zelle am spezifizierten Index und der
     * daraufolgenden Zelle wieder.
     *
     * @param index
     * @return default:<code>0</code>
     */
    public int getRowMargin(final int index) {
        return 0;
    }

    /**
     * Veranlasst den Editor die grafische Komponente für die Zelle am
     * spezifizierten Index zu erzeugen.<br>
     * Die Funktion kann zum Beispiel verwendet werden, um bereits vor dem
     * Editieren Informationen über die darszustellende Komponente zu erhalten
     * (Layout, etc.).
     * 
     * @param editor
     * @param index
     * @return
     */
    public Component prepareEditor(final ListCellEditor editor, final int index) {
     ...
     *
     * @param y0
     * @return -1, wenn y0 ausserhalb der Koordinaten dieser
     *         {@link ExtendedJList} liegt.
     */
    ...
    private void paint(final int fromIndex, final int toIndex) {
