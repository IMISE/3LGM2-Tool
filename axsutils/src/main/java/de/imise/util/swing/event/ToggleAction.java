...
public class ToggleAction extends ExtendedAction {
    ...
    public void actionPerformed(final ActionEvent e) {
        /*
         * Testausgabe im Zusammenhang mit dem Abschaffen der Richtung von Kanten
         * GDCollection gdcoll = Static.getTool().getSelectedGDCollection();
         * HashSet<Class<? extends ModelElement>> classes = new HashSet<>();
         * for (ModelElement me : gdcoll.getGraphDocument().getModelItems(Kante.class, true)) {
         * Doppelkante edge = (Doppelkante) me;
         * if (edge.getDirection() == Doppelkante.BACKWARD || edge.getDirection() == Doppelkante.DOUBLE)
         * classes.add(edge.getClass());
         * }
         * for (Class<? extends ModelElement> elemClass : classes) {
         * boolean f = false, b = false, d = false;
         * for (ModelElement me : gdcoll.getGraphDocument().getModelItems(elemClass)) {
         * Doppelkante edge = (Doppelkante) me;
         * if (edge.getDirection() == Doppelkante.FORWARD && !f) {
         * f = true;
         * } else if (edge.getDirection() == Doppelkante.BACKWARD && !b) {
         * b = true;
         * } else if (edge.getDirection() == Doppelkante.DOUBLE && !d) {
         * d = true;
         * }
         * }
         * if (f)
         * System.err.println("F " + elemClass.getSimpleName());
         * if (b)
         * System.err.println("B " + elemClass.getSimpleName());
         * if (d)
         * System.err.println("D " + elemClass.getSimpleName());
         * if (f || b || d)
         * System.err.println();
         * }
         */
