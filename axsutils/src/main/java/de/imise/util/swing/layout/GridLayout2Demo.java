...
public class GridLayout2Demo extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        new GridLayout2Demo(new GridLayout(3, 2, 2, 2), createPanelComponets());
        new GridLayout2Demo(new GridLayout2(3, 2, 2, 2), createPanelComponets());
        new GridLayout2Demo(2, new Insets(1, 1, 1, 1), createPanelComponets());
    }
}
