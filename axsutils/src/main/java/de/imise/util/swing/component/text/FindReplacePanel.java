...
public class FindReplacePanel extends JPanel implements ActionListener {
	 ...
	 * Suchfeld
	 */
	private HistoryComboBox elementFind = new HistoryComboBox();
	/**
	 * Ersetzenfeld
	 */
	...
	private JCheckBox onlyWholeWord_cb = new JCheckBox(resHandler.getString("TOOLS_FINDREPLACEPANEL_CB_WW"), onlyWholeWord);
	...
	private JRadioButton back_direction_rb = new JRadioButton(resHandler.getString("TOOLS_FINDREPLACEPANEL_RB_B"), !normal_direction);
	 ...
	 * @param textComponent
	 */
	public FindReplacePanel(JComponent textComponent) {
		super();
		// baue nur das JPanel
		init(textComponent);
	}
	 ...
	 * @param textComponent
	 */
	public void showFindReplaceDialog(JComponent textComponent, int x, int y) {
	 ...
	 * @param textComponent
	 */
	private void init(Object textObject) {
		this.removeAll();
