...
public interface ListCellEditor extends CellEditor {
     ...
     * 
     * @param list Liste, die die zu editierende Zelle enthält
     * @param value Initaler Wert des Editors
     * @param isSelected Zelle ist selektiert
     * @param index Index der Zelle innerhalb der Liste
     */
