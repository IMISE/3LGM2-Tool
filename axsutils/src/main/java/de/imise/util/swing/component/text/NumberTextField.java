 ...
 * @author AXS
 */
public class NumberTextField extends ExtendedJFormattedTextField {
     ...
     * @param positiveOnly
     */
    protected NumberTextField(final NumberFormat numberFormat, final boolean positiveOnly) {
        super(numberFormat);
     ...
     * @return
     */
    public static NumberTextField getNumberTextField(final NumberFormat numberFormat, final boolean positiveOnly) {
     ...
     * @return
     */
    public static NumberTextField getNumberTextField(final int decimalPlaces, final boolean positiveOnly) {
     ...
     * @return
     */
    public static NumberTextField getNumberTextField(final String formatPattern, final boolean positiveOnly) {
