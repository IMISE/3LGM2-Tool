...
public class BasicTree extends JTree {
     ...
     * @param comparator
     */
    public BasicTree(final Comparator<Object> comparator) {
        super();
     ...
     * @param node2add
     */
    public void addNodeAndRefreshTree(final DefaultMutableTreeNode parent, final DefaultMutableTreeNode node2add) {
     ...
     * @param index
     */
    public void insertNodeAndRefreshTree(final DefaultMutableTreeNode parent, final DefaultMutableTreeNode node2add, final int index) {
        //Expansion merken
        saveExpansionState();
     ...
     * @param node2Insert
     */
    public void insertNodeAlphabeticalAndRefreshTree(final DefaultMutableTreeNode parent, final DefaultMutableTreeNode node2Insert) {
     ...
     * @param startIndex
     */
    public void insertNodeAlphabeticalAndRefreshTree(final DefaultMutableTreeNode parent, final DefaultMutableTreeNode node2Insert, final int startIndex) {
        //Expansion merken
        saveExpansionState();
     ...
     * @param node2Remove
     */
    public void removeNodeAndRefreshTree(final DefaultMutableTreeNode node2Remove) {
        //Expansion merken
        saveExpansionState();
     ...
     * @param nodes2Remove
     */
    public void removeNodesAndRefreshTree(final Iterable<MutableTreeNode> nodes2Remove) {
        //Expansion merken
        saveExpansionState();
        //für alle zu entfernenden Knoten
        for (MutableTreeNode node2Remove : nodes2Remove) {
     ...
     * @param node
     */
    protected void selectNode(final TreeNode node) {
     ...
     * @param node
     */
    protected void editNode(final DefaultMutableTreeNode node) {
