 ...
 * random dragging of components with the Container. The location of the
 * component will not be managed by the layout manager. The size of the
 * component can be either the preferred size of the component, or the actual
 * size of the component. The preferred size of the container will calculated
 * normally based on the actual location and size of each component. A Component
 * cannot have a location outside the bounds of the parent container. That is
 * the x/y coordinate must be withing the Insets of the Container. If any
 * component is outside the bounds, then the location of all components will be
 * adjusted by the same amount.<br>
 * Source: <a href=
 * "https://tips4java.wordpress.com/2011/10/23/drag-layout/">https://tips4java.wordpress.com/2011/10/23/drag-layout/</a><br>
 * Source: <a href=
 * "http://www.camick.com/java/source/DragLayout.java">http://www.camick.com/java/source/DragLayout.java</a>
 */
public class DragLayout implements LayoutManager, java.io.Serializable {
     ...
     */
    public DragLayout(final boolean usePreferredSize) {
     ...
     *            component in layout calculations. When false, use the size of
     *            the component, unless the size is 0, in which case use the
     *            preferred size as a default.
     */
    public void setUsePreferredSize(final boolean usePreferredSize) {
     ...
     * @param parent the container in which to do the layout
     */
    private Dimension getLayoutSize(final Container parent) {
    ...
    private Dimension getActualSize(final Component component) {
        if (usePreferredSize) {
