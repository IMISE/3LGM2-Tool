...
public class BlockScrollableJPanel extends JPanel implements Scrollable {
     ...
     */
    public BlockScrollableJPanel(final int maxUnitIncrement) {
        super();
     ...
     * @param maxUnitIncrement
     */
    public BlockScrollableJPanel(final LayoutManager layout, final int maxUnitIncrement) {
        super(layout);
        this.maxUnitIncrement = maxUnitIncrement;
    }
     ...
     * @param maxUnitIncrement
     */
    public BlockScrollableJPanel(final boolean isDoubleBuffered, final int maxUnitIncrement) {
     ...
     * @param maxUnitIncrement
     */
    public BlockScrollableJPanel(final LayoutManager layout, final boolean isDoubleBuffered, final int maxUnitIncrement) {
