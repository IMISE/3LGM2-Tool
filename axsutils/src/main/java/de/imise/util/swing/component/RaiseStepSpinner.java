...
public class RaiseStepSpinner extends JSpinner implements ChangeListener, MouseListener, KeyListener, FocusListener {
	 ...
	 * @param initialValue
	 */
	public RaiseStepSpinner(int min, int max, int initialValue) {
	 ...
	 * @param decimalPlace
	 */
	public RaiseStepSpinner(double min, double max, double initialValue, int decimalPlace) {
		super();
    ...
    private class MySpinnerUI extends BasicSpinnerUI {
		 ...
		 * @param mouseListener
		 */
		public MySpinnerUI(MouseListener mouseListener) {
			super();
