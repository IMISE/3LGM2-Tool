...
/**
 * AXS (19.08.07): Habe dieses Tab Pane ins util-Package genommen. Es ist gar nicht kommentiert und
 * ich habe nicht geprüft, was es besonderes kann und ob man es wirklich unbedingt braucht. 
 * 
 * 
 * 
...
//			if (!e.isPopupTrigger() && e.getButton() == MouseEvent.BUTTON1) {
	 ...
	 * @param b
	 */
	public void setTabsInOneLineLayout (boolean b) {
		if (b)
