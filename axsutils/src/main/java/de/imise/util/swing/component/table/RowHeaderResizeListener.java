...
public class RowHeaderResizeListener extends MouseAdapter {
    ...
    /**
     * Verändert den Cursor-Typ in Abhängigkeit seiner Position. Ist er über dem
     * Rand zwischen rowHeader und table, wechselt er in die resize-Dartsellung,
     * sonst wir der Standard-Cursor angezeigt.
     *
     * @param e
     ...
     * Breite unterschritten wird. Unterbindet das Vergrößern, falls die Breite
     * des rowHeaders fast die Fensterbreite erreicht.
     * 
     * @param e
