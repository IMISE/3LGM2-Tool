...
/**
 * The FormScroller will ensure that when a component gains focus it will always
 * be visible within the viewport of the scrollpane.<br>
 * <br>
 * Source: https://tips4java.wordpress.com/2010/05/09/scrolling-a-form/
 */
public class FormScroller implements PropertyChangeListener {
     ...
     * @param scrollPane
     */
    public FormScroller(final JScrollPane scrollPane) {
     ...
     * @param type
     */
    public FormScroller(final JScrollPane scrollPane, final Type type) {
    ...
    /**
     * @return the Type of scrolling to be attempted by the scroller
     */
    public Type getType() {
        return type;
    }
     ...
     * focused component should be visible in the viewport. Type.PARENT - the
     * parent Container of the focus component should be visible in the
     * viewport. If the parent Container does not fit completely then use
     * Type.COMPONENT. Type.CHILD - the child Contaier of the viewport view
     * component which contains the focused component should be visible in the
     * viewport. If the child Container does not fit completely then use
     * Type.PARENT.
     *
