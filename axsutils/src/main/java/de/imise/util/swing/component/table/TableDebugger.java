 ...
 * <p>
 * <b>Hinweis:</b> An einen Table werden hier üblicherweise Listener angehängt,
 * welche anschließend nicht entfernt werden. Daher sollte diese Klasse auch nur
 * zum Debuggen verwendet werden, nicht aber beim "tatsächlichen Bertieb".
 *
 * @author fstephan
 */
public class TableDebugger {
    ...
    protected static class SelectionCheckModel extends AbstractTableModel {
        ...
        public SelectionCheckModel(final JTable source) {
            this.source = source;
     ...
     * 
     * @param source Die Ausgangstabelle
     * @param show
     *            <ul>
     *            <li><code>true</code>: Es wird ein Dialog geöffnet, der die
     *            Debugging-Tabelle anzeigt</li>
     *            <li><code>false</code>: Die Tabelle wird nur erzeugt und
     *            zurückgegeben</li>
     *            </ul>
     * @param owner Der WindowOwner für den Dialog. (optional)
     * @return Tabelle der Selektionswerte
     */
    public static JTable selectionDebugger(final JTable source, final boolean show, final Window owner) {
     ...
     * 
     * @param debuggingModel Das Modell, welches als Basis für die hier erzeugte
     *            Tabelle dient.
     * @param show
     *            <ul>
     *            <li><code>true</code>: Es wird ein Dialog geöffnet, der die
     ...
     * @return Tabelle der Selektionswerte
     */
    public static JTable debugger(final TableModel debuggingModel, final boolean show, final Window owner) {
