...
/**
 * Ein {@link WindowListener}, der beim Eintreffen von {@link WindowEvent} die
 * jeweils festgelegte Aktion ausführt.
 * 
 * @author fstephan
 */
public class LGMWindowListener implements WindowListener {
    ...
    /**
     * Aktion, die ausgeführt wird, wenn von einem Fenster das Icon entfernt
     * wurde.
     */
    private FlexibleEventAction windowDeiconifiedAction;

    /**
     * Aktion, die ausgeführt wird, wenn bei einem Fenster ein Icon hinzugefügt
     * wurde.
     */
    ...
    /**
     * Ein {@link WindowListener}, der beim Eintreffen von {@link WindowEvent}
     * die jeweilige übergebene Aktion ausführt, wenn diese nicht null ist
     * Konstruktor
     * 
     ...
     */
    public LGMWindowListener(FlexibleEventAction windowActivatedAction, FlexibleEventAction windowClosedAction, FlexibleEventAction windowClosingAction, FlexibleEventAction windowDeactivatedAction, FlexibleEventAction windowDeiconifiedAction,
            FlexibleEventAction windowIconifiedAction, FlexibleEventAction windowOpenedAction) {
        super();
