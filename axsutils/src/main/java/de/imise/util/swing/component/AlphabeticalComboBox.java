...
public class AlphabeticalComboBox extends JComboBox {
	 ...
	 * @param Leerfeld?
	 */
	public AlphabeticalComboBox(boolean nullAble) {
		this(0);
	 ...
	 */
	public AlphabeticalComboBox(Collection<Object> objects) {
		this(objects, 0);
	}
	 ...
	 */
	public AlphabeticalComboBox(int shift) {
		super();
	 ...
	 * 			Anzahl der Leerzeichen, die vor jedem Listeneintrag dargestellt werden sollen
	 */
	public AlphabeticalComboBox(Collection<Object> objects, int shift) {
		this(shift);
...
//			insertItemAt(anObject, 1);
	 ...
	 * @param o
	 */
	public int setSelectedObject(Object o){
	 ...
	 */
	public void addSeparator(boolean showSeparatorLine) {
	 ...
	 * als Objekt und dem Anzeige-String <code>anObject.toString()</code>, dem <code>shift</code>
	 * Leerzeichen vorangestellt werden.
	 * 
	 * @param anObject
	 * @param shift
	 */
	public void addItem(Object anObject, int shift) {
	 ...
	 */
	public void addItem(Object anObject, String displayName, int shift) {
	...
	protected void selectedItemChanged() {
		...
		//wenn etwas anderes als ein Separator selektiert wurde (das ist eine korrekte Selektion)
		else {
	 ...
	 * 
	 * Wird dem Separator kein eigener <code>String</code> übergeben, wird er als <code>JSeparator</code>
	 * gerendert. Wird ein <code>String name</code> übergeben, so wird dieser angezeigt.
	 * 
	 * @author AXS
	 *
	 * @created 19.10.2007
	...
	private class MyRenderer extends DefaultListCellRenderer{
		...
		/**
		 * Erzeugt einen neuen Renderer, der alle Einträge, die keinen Separatoren sind um <code>shift</code>
		 * Leerzeichen nach rechts verschiebt.
		 * 
		 * @param shift
