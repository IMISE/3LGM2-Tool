 ...
 * <p>
 * Ermöglich den Zugriff auf bzw. das Setzen der durch {@link Action} gegebenen Properties über get- bzw. set-Methoden.
 * <br>
 * 
 * @author fstephan, AXS
 */
public abstract class ExtendedAction extends AbstractAction {
	 ...
	 * Die Mnemonic-Property wird hier ausgeschlossen, da sie üblicherweise innerhalb von {@link AbstractButton}-Gruppen
	 * gemeinsam gesetzt wird und beim Erzeugen der Action noch nicht bekannt ist.
	 * </p>
	 * 
	 * @param text
	 * @param smallIcon
	 ...
	 *            Initialer Selektionszustand für die Verwendung bei {@link JCheckBoxMenuItem}s und
	 *            {@link JRadioButtonMenuItem}s
	 */
	public ExtendedAction(String text, Icon smallIcon, Icon largeIcon, KeyStroke keyStroke, String shortDescription, String longDescription, String actionCommand, Boolean initialSelectionState) {
		this(text, smallIcon);
	 ...
	 * @param smallIcon
	 */
	public ExtendedAction(String text, Icon smallIcon) {
	...
	/**
	 * Setzt den Selektionszustand dieser Action. (Zur Verwendung bei {@link JRadioButtonMenuItem} und
	...
	/**
	 * Setzt den Selektionszustand dieser Action. (Zur Verwendung bei {@link JRadioButtonMenuItem} und
	 * {@link JCheckBoxMenuItem}). Bei <code>null</code> wird <code>false</code> gesetzt.
	 * 
	 * @param b
	 */
	public void setSelected(Boolean b) {
	...
	/**
	 * Gibt den Selektionszustand dieser Action wieder. (Zur Verwendung bei {@link JRadioButtonMenuItem} und
	 * {@link JCheckBoxMenuItem}) <br>
	 * Falls kein Selektionszustand gesetzt wurde, wird <code>false</code> zurückgegeben.
	 * <p>
	 * Durch Überschreiben dieser Methode kann der Selektionszustand dynamisch festgelegt werden. Allerdings ist dann
	 * eine Beeinflussung durch {@link #putValue(String, Object)} nicht mehr möglich.
	 * 
	 * @param b
	 */
	 ...
	 */
	public void putValues(Pair<String, Object>... keysAndValues) {
	 ...
	 *            - erstes Item: key - zweites Item: value
	 */
	public void putValue(Pair<String, Object> keyAndValue) {
	 ...
	 */
	public void setAllAttributes(ExtendedAction source) {
		clearAttributes();
	 ...
	 * Achtung: Die Attributwerte werden hierbei nicht geclont!
	 */
	public void addAttributesFrom(ExtendedAction source) {
