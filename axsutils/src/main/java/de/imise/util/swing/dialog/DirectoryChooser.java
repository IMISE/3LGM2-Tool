/*
 * Created on 16.01.2004 To change the template for this generated file go to
...
/**
 * @author Thomas Rudert Dialog zum auswählen eines Verzeichnisses.<br>
 *         Die Datei besteht aus den mehreren Klassen, die alle für den
 *         <code>DirectoryChooser</code> gebraucht werden.
 */
public class DirectoryChooser extends JDialog {
     ...
     */
    private DirectoryChooser(final Dialog owner) throws HeadlessException {
     ...
     * @throws java.awt.HeadlessException
     */
    private DirectoryChooser(final Frame owner) throws HeadlessException {
        super(owner, true);
        init();
    }
     ...
     */
    public static File showDialog(final Dialog owner) {
     ...
     * 
     * @param owner the owner of the Dialog
     * @param newDirName defaultName for a created directory
     * @return File with directory, if a directory was selected and the Dialog
     *         was closed with APPROVE_OPTION; otherwise null
     */
    public static File showDialog(final Dialog owner, final String newDirName) {
     ...
     *         was closed with APPROVE_OPTION; otherwise null
     */
    public static File showDialog(final Frame owner) {
        return showDialog(owner, "");
    }
     ...
     *         was closed with APPROVE_OPTION; otherwise null
     */
    public static File showDialog(final Frame owner, final String newDirName) {
        DirectoryChooser dialog = new DirectoryChooser(owner);
        dialog.setVisible(true);
        return dialog.approveOption ? dialog.selectedDir : null;
    }
