...
public class Pixel extends Point {
    ...
    /**
     * Minimaler Rotwert, der noch als gleich zu der korrekten Farbe dieses
     * Pixels anerkannt werden soll
     */
    protected int minR;

    /**
     * Maximaler Rotwert, der noch als gleich zu der korrekten Farbe dieses
     * Pixels anerkannt werden soll
     */
    protected int maxR;

    /**
     * Minimaler Grünwert, der noch als gleich zu der korrekten Farbe dieses
     * Pixels anerkannt werden soll
     */
    protected int minG;

    /**
     * Maximaler Grünwert, der noch als gleich zu der korrekten Farbe dieses
     * Pixels anerkannt werden soll
     */
    protected int maxG;
    /**
     * Minimaler Blauwert, der noch als gleich zu der korrekten Farbe dieses
     * Pixels anerkannt werden soll
     */
    protected int minB;

    /**
     * Maximaler Blauwert, der noch als gleich zu der korrekten Farbe dieses
     * Pixels anerkannt werden soll
     */
    protected int maxB;
    /**
     * <code>false</code> bedeutet, der Pixel soll genau die Farbe
     * <code>rgb</code> haben, <code>true</code> bedeutet, er soll genau diese
     * Farbe nicht haben.
     */
    ...
    /**
     * Definiert einen Pixel, dessen Farbe und wie stark ein Vergleichspixel in
     * den Farbwerten rot, grün und blau abweichen darf.<br>
     * 
     * @param x
     * @param y
     * @param color
    ...
    /**
     * Liefert <code>true</code>, wenn dieser Pixel in den Toleranzen mit dem
     * übergebenen Punkt im übergebenen Bild übereinstimmt.
     * 
     * @param image
     * @return
     */
    ...
    /**
     * Liefert <code>true</code>, wenn die Farbe des Pixels in den Toleranzen
     * mit der übergebenen Farbe übereinstimmt.
     * 
     * @param color
     * @return
     */
