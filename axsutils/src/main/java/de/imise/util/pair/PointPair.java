...
public class PointPair {
    ...
    /**
     * @return Absolute (alsways positve) difference between x1 and x2.
     */
    public int getWidth() {
        int width = x2 - x1;
        if (width < 0)
    ...
    /**
     * @return Absolute (alsways positve) difference between y1 and y2.
     */
    ...
    /**
     * Malt mit den aktuellen Zeichenenstellungen von <code>g</code> ein
     * Rechteck auf <code>g</code>.
     * 
     * @param g
     */
