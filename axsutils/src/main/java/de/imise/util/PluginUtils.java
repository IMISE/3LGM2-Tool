...
/**
 * Funktionen zum Laden von Klassen aus jar-Dateien, wie es beim Laden von
 * Plugins vorkommt.
 *
...
public class PluginUtils {
    ...
    /**
     * Wenn das übergebene File ein Jar-File ist, dann werden daraus alle
     * Klassen herausgesucht, die zuweisungskompatibel zur übergebenen Klasse
     * sind. Ist das File kein Jar-File oder keine solche Klasse im Jar-File,
     * kommt eine leere Liste zurück.
     *
     * @param resultClasses Liste, zu der die übergebenen Klassen hinzugefügt
     *            werden
     * @param jarFileFile Pfad zum Jar-File
     * @param superClassOfResultClasses (Ober-)Klasse, der zu findenden Klassen
     * @return Liste aller Klassen, die im Jar-File gefunden wurden und
     *         zuweisungkompatibel zur übergebenen Klasse sind
     */
    ...
    /**
     * Lädt aus dem übergebenen Verzeichnis alle Klassen der übergebenen Art,
     * ruft dann von jeder Klasse den parameterlosen Konstruktor auf und gibt
     * alle Instanzen zurück, bei denen der Aufruf des Konstruktors ohne Fehler
     * geklappt hat.
     *
     * @param file
     * @param superClassOfResultClasses
     * @param findOnlyOne wenn <code>true</code> ist in der Rückgabeliste nur 1
     *            Element und zwar das zuerst gefundene. Damit kann man die
     *            weitere Suche abbrechen, wenn klar ist, dass max. 1 Element
     *            zurück kommen kann.
    ...
    /**
     * Lädt aus dem übergebenen Verzeichnis die alle Klassen der übergebenen
     * Art, ruft dann von der jeweils nächsten Klasse den parameterlosen
     * Konstruktor auf und gibt die erste Instanz zurück, bei denen der Aufruf
     * des Konstruktors ohne Fehler geklappt hat.
     *
     * @param file
     * @param superClassOfResultClasses
