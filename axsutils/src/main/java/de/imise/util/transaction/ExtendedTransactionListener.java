 ...
 * <p>
 * Lauscht auf das Abbrechen einer Transaktion sowie auf das Durchführen von
 * UNDO bzw. REDO.
 * <p>
 * Durch die zusätzliche Erweiterung des {@link EventListener}-Interfaces, kann
 * der {@link ExtendedTransactionListener} auch in Java-Klassen eingesetzt
 * werden.
 * 
 * @author fstephan
 */
