...
public abstract class AbstractTransactionManager implements TransactionManager {
	...
	/*
	 * (non-Javadoc)
	 * @see tool3lgm.util.transaction.TransactionManager#addPropertyChangeListener(java.beans.PropertyChangeListener)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see tool3lgm.util.transaction.TransactionManager#removePropertyChangeListener(java.beans.PropertyChangeListener)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see tool3lgm.util.transaction.TransactionManager#addTransactionListener(tool3lgm.util.transaction.ExtendedTransactionListener)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see tool3lgm.util.transaction.TransactionManager#removeTransactionListener(tool3lgm.util.transaction.ExtendedTransactionListener)
	 */
	@Override
	...
	/**
	 * Benachrichtigt alle {@link ExtendedTransactionListener}s, dass die aktuelle Transaktion beendet ist.
	 */
	...
	/**
	 * Benachrichtigt alle {@link ExtendedTransactionListener}s, dass die aktuelle Transaktion abgebrochen wurde.
	 */
	 ...
	 * @param newValue
	 * 			neuer Wert, der "undoAvailable"-Property
	 */
	 ...
	 * @param newValue
	 * 			neuer Wert, der "redoAvailable"-Property
	 */
