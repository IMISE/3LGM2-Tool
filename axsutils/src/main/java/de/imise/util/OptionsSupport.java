...
/**
 * Klasse, die Funktionalität bereit stellt, um das den Zustand von
 * boolean-Optionen zu verwalten.
 *
...
public class OptionsSupport {
    ...
    /**
     * Wenn eine MODEL_OPTION für dieses GraphDocument true ist, dann muss das
     * zugehörige GDCommand in dieser Collection sein.
     */
    private final Collection<Object> trueOptions = new HashSet<>();

    /**
     * Liefert <code>true</code>, wenn die Option mit der übergebenen ID zuvor
     * auf <code>true</code> gesetzt wurde.
     *
     * @param optionId
     * @return
     */
