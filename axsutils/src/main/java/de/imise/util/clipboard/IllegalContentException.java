...
/**
 * Exception, die geworfen wird, wenn ein {@link ContentParser} interne bzw.
 * externe Inhalte nicht umwandeln kann.
 * 
 * @author fstephan
 */
public class IllegalContentException extends Exception {
     ...
     * Konstruktor
     *
     * @param content Inhalt, der nicht umgewandelt werden kann
     */
