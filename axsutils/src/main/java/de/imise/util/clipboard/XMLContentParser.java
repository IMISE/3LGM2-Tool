...
class XMLContentParser {
     ...
     * @see #PARSER_MAP
     */
    private Map<String, File> parsers;
     ...
     * @return
     */
    public String[][] toStringArray(final String contentString) throws NullPointerException {
        return null;
    }
     ...
     * @return
     */
    public String toCSVString(final String contentString) throws NullPointerException {
     ...
     * @return
     */
    private static final String toString(final File file) {
     ...
     * @param contentString
     */
    private void setCCSTempFile(final String contentString) {
     ...
     * @return
     */
    private static final File[] splitFile(final File file) {
     ...
     */
    @SuppressWarnings("unused")
    private static final String correct(final String contentString) {
        int lastPos = 0;
        int pos1;
        int pos2;
    ...
    public static XMLContentParser getDefaultParser() {
        ...
        if (defaultParser == null) { // defaultParser noch nicht erzeugt
            ...
            defaultParser.parsers = new HashMap<>(1, 1);
