 ...
 * <p>
 * Bekannte Fehler:
 * <li>leere Zellen am rechten und unteren Rand einer Selektion in einer
 * Excel-Tabelle werden nicht übernommen
 * 
 * @see
 * @author Frank
 */
public class SimpleContentParser implements ClipboardConstants, ContentParser {
    ...
    /**
     * Wandelt, wenn möglich, <code>externalContent</code> in ein ObjectArray
     * um.<br>
     * Falls eine Umwandlung nicht möglich ist, wird eine
     * {@link IllegalContentException} geworfen.
     * <p>
     ...
     * Wandelt, wenn möglich, <code>externalContent</code> in ein ObjectArray
     * um.<br>
     * Falls eine Umwandlung nicht möglich ist, wird <code>null</code>
     * zurückgegeben.
     * 
    ...
    /**
     * Ersetzt jedes <code>null</code> in <code>internalContent</code> durch den
     * leeren String.
     * 
    ...
    /**
     * Wandelt, wenn möglich, <code>internalContent</code> in einen
     * <code>String</code> um.<br>
     * Falls eine Umwandlung nicht möglich ist, wird eine
     * {@link IllegalContentException} geworfen.
     * <p>
     ...
     * <li><code>Object[][]</code>
     * <li><code>String[][]</code>
     * <li>gültige <code>Collection</code>s (<b>siehe auch:</b>
     * {@link CollectionUtils#toArray(Collection)})
     * 
     * @throws IllegalContentException
    ...
    /**
     * Wandelt <code>rows</code> in ein <code>String[][]</code> um, falls es
