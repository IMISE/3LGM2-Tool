...
/**
 * {@link KeyListener}, der cut, copy und paste für einen
 * {@link ContentExchanger} steuert.
 * 
 * @author fstephan
 */
public class ContentExchangeListener extends KeyAdapter {
     ...
     * Konstruktor
     * 
     * @param contentExchanger zu steuernder {@link ContentExchanger}
     */
    ...
    public void keyPressed(KeyEvent e) {
        if (e.isControlDown()) {
            ...
            switch (keyCode) {
            case KeyEvent.VK_C:
                contentExchanger.copy();
                break; // kopieren
            case KeyEvent.VK_X:
                contentExchanger.cut();
                break; // ausschneiden
            case KeyEvent.VK_V:
                contentExchanger.paste();
                break; // einfügen
            }
