...
public class ReflectionUtils {
	 ...
	 * @return
	 */
	public static final Class<?> getCommonSuperClass(Object o1, Object o2) {
		if (o1 == null)
		...
		Class<?> c2 = (o1 instanceof Class<?>) ? (Class<?>) o2 : o2.getClass();
	 ...
	 * @return
	 */
	public static final <T> Class<? extends T> getCommonSuperClass(Class<? extends T> class1, Class<? extends T> class2) {
		if (class1 == null)
			return class2;
		if (class2 == null)
			return class1;
	 ...
	 * @return
	 */
	public static final Class<?> getCommonSuperClass(List<?> objectListOrClassList, int startIndex, int endIndex) {
	 ...
	 * @return
	 */
	public static final Class<?> getCommonSuperClass(Collection<?> objectListOrClassList) {
		if (objectListOrClassList == null || objectListOrClassList.size() == 0)
			return null;
	 ...
	 * @return
	 */
	public static final Class<?> getCommonSuperClass(Object[] objectArray) {
	 ...
	 * @return
	 */
	public static final Class<?> getMostSpecialElementClass(Object o1, Object o2) {
	 ...
	 * @return
	 */
	public static final void removeSubClasses(List<Class<?>> classList) {
	 ...
	 * @return
	 */
	public static final void removeSuperClasses(List<Class<?>> classList) {
		for (int i = 0; i < classList.size(); i++) {
			Class<?> c1 = classList.get(i);
			for (int j = i + 1; j < classList.size(); j++) {
				Class<?> c2 = classList.get(j);
	 ...
	 * @return
	 */
	public static boolean hasSameClass(ArrayList<?> objectList) {
	 ...
	 * @return
	 */
	public static final int getFirstAssignableIndex(Object[] objectList, Class<?> clazz) {
	 ...
	 */
	public static final boolean containsAssignable(Object[] objectList, Class<?> clazz) {
	 ...
	 * @return
	 */
	public static final String getAbsoluteDirectory(Class<?> clazz) {
