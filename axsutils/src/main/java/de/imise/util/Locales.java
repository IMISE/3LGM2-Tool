...
public class Locales {
	...
	/**
	 * Liefert eine System-<code>Locale</code>, die der Sprache des übergebenen String entspricht.<br>
	 * Wird ein 5-Zeichen locale-String übergeben, werden die ersten beiden Zeichen als Sprache
	 * angenommen. Bei einem 2-Zeichen-String wird diese direkt als Sprache angenommen. Bei
	 * Strings anderer Länge kommt <code>null</code> zurück, genauso wenn keine passende Locale
	 * gefunden wurde.
	 * @param localeString
	 * @return
	 */
