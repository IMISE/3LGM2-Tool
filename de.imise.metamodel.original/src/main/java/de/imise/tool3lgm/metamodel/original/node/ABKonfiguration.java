...
public final class ABKonfiguration extends Node {
    ...
    public ElementPropertyDialog createPropertyDialog() {
        ...
        dialog.addDescripDescriptedPanel(AwbkAufOrgVerbindung.class, AufAufOrgVerbindung.class);
        dialog.addPathConnectionPanel(AwbAwbkVerbindung.class);
        dialog.addPathConnectionPanel(AwbkAufOrgVerbindung.class, OrgAufOrgVerbindung.class);
        return dialog;
    }
