...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:key name="AWP"
		match="/modell_3lgm_2/objects/element[@class='AwpSwpVerbindung']" use="child::field[@name='end']" />
			...
			<body>
				...
				<table border="1" cellpadding="2" cellspacing="0">
					...
					<tbody valign="top" align="left">
						<tr>
							<xsl:apply-templates
								select="modell_3lgm_2/objects/element[@class='Softwareprodukt']">
	...
	<xsl:template match="element[@class='Softwareprodukt']">
		<xsl:variable name="AWBKs"
			select="key('AWBK', key('AB',key('AWP',@hash)/child::field[@name='start'])/child::field[@name='start'])" />
		<xsl:choose>
			<xsl:when
				test="count(key('hash',key('AUF',key('KOH',$AWBKs/child::field[@name='start'])/child::field[@name='start'])/child::field[@name='start'])) &gt; 0">
				<td>
				...
				<td>
					<xsl:for-each
						select="key('hash',key('AUF',key('KOH',$AWBKs/child::field[@name='start'])/child::field[@name='start'])/child::field[@name='start'])">
