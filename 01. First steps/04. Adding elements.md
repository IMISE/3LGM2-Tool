...
Similar to above you can creat application components using the context menu by right clicking on an empty field in the document view.
...
* you can also select the component interfaces and use the context menu to add the communication link. This can also be done if only one of the application components has a communcation interface. In this case you can select the desired communication interface and the application component and use the context menu to create the communication link.
