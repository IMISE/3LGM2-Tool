 ...
 * "Aufgabe_ID", "Aufgabe", "Teilaufgabe_ID", "Teilaufgabe", "Beschreibung", "Ort der Durchführung", "Verantwortliche Rolle", "Anwendungssystem", "Physischer DV-Baustein", "Benötiger Speicherplatz"
 * 
 * @author AXS
 * @create 02.07.2012
 */
public class B1ExportPlugin implements Plugin {
	 ...
	 * @return
	 */
	public int getHierarchyDepth(ElementContainer ec) {
