...
public class ToolBar extends UnfloatableToolBar implements ActionListener, MouseListener{
	...
	private JToggleButton fach, log, phy;

	private JButton neu, open, save;
...
/*	private JButton testButton = new JButton(new AbstractAction("Test"){
	...
	private static final JButton createToolBarButton(Action action, String iconName, String toolTipResKey, String helpID) {
	...
	public void addWindow(AbstractInternalFrame frame) {
	...
	public void removeWindow(AbstractInternalFrame frame) {
		if (operatingWindowList)
			return;
	 ...
	 * @param c
	 */
	public void setActiveLayer(int c) {
		switch (c) {
