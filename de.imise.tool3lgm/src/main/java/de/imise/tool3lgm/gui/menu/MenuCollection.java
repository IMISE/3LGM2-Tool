...
public class MenuCollection {
	...
	/** Das Bearbeiten-Menu */
	public static final JMenu EDIT_MENU = createMenu (
			Tool3lgmConstants.getResString("edit"),

			ActionLibrary.EditActions.UNDO,
			ActionLibrary.EditActions.REDO,
			new JSeparator(),
			ActionLibrary.EditActions.SEARCH,
			new JSeparator(),
			...
			ActionLibrary.EditActions.CLEAR_CLIPBOARD,
			new JSeparator(),
			ActionLibrary.EditActions.REMOVE_FROM_SUBMODEL,
			ActionLibrary.EditActions.REMOVE_FROM_MODEL
	);
	...
	public static final JMenu SUBMODEL_MENU = createMenu (
			...
			Tool3lgmConstants.getResString("submodels"),
			ActionLibrary.SubmodelActions.NEW,
			ActionLibrary.SubmodelActions.REMOVE,
			new JSeparator(),
			ActionLibrary.SubmodelActions.RENAME
	);

	/** Das XMLAnalyse-Menu */
	public static final JMenu ANALYSIS_MENU = createMenu (
			Tool3lgmConstants.getResString("analysis"),
			...
			createCheckBoxItem(ActionLibrary.OptionsActions.Analysis.NEW_SUBMODEL),
			new JSeparator(),
			ActionLibrary.AnalysisActions.ACTIVATE_REDUNDANCY_ANALYSIS,
			ActionLibrary.AnalysisActions.ACTIVATE_DATA_AVAILABILITY,
			createCheckBoxItem(ActionLibrary.OptionsActions.Analysis.CONFIGURATIONAL_REDUNDANCY),
			createCheckBoxItem(ActionLibrary.OptionsActions.Analysis.DATA_REDUNDANCY)

	);

	/** Das Optionen-Menu */
	public static final JMenu OPTIONS_MENU = createMenu (
			Tool3lgmConstants.getResString("options"),

			OptionsSubMenus.GENERAL_OPTIONS_MENU,
			OptionsSubMenus.BROWSER_OPTIONS_MENU,
			OptionsSubMenus.GRAPHICS_OPTIONS_MENU,
			ActionLibrary.OptionsActions.OPEN_RMI_SETTINGS,
			OptionsSubMenus.LOCALE_MENU
	);

	/** Das Extras-Menu */
	public static final JMenu EXTRAS_MENU = createMenu (
			Tool3lgmConstants.getResString("extras"),

			ActionLibrary.ExtrasActions.USERFIELD_DEFINITION_DIALOG,
			ActionLibrary.ExtrasActions.ATTRIBUTE_EDITOR,
			createCheckBoxItem(ActionLibrary.OptionsActions.Analysis.ACTIVATE_CALCULATION),
			new JSeparator(),
			ActionLibrary.ExtrasActions.AUTOMATIC_ETMT_ASSIGNMENT,
			new JSeparator(),
			createCheckBoxItem(ActionLibrary.AnalysisActions.ACTIVATE_CONSISTENCY_CHECK),
	...
	private static JMenu createMenu(String title, Object... entries) {
		return MenuCreator.createMenu(title, entries, true);
	}

	/** Erzeugt ein {@link JCheckBoxMenuItem} mit der übergebenen {@link Action} */
	private static JCheckBoxMenuItem createCheckBoxItem (Action a) {
	...
	static class FileSubMenus {
		...
		/** Das Import-Menu */		
		public static final JMenu IMPORT_MENU = createMenu (
				Tool3lgmConstants.getResString("import"),

				ActionLibrary.FileActions.ImportActions.IMPORT_SUBMODEL,
				ActionLibrary.FileActions.ImportActions.IMPORT_MODEL,
				new JSeparator(),
				ActionLibrary.FileActions.ImportActions.IMPORT_DATA
		);	

		/** Das Export-Menu */
		public static final JMenu EXPORT_MENU = createMenu (
				Tool3lgmConstants.getResString("export"),

				ActionLibrary.FileActions.ExportActions.EXPORT_GRAPHIC,
				new JSeparator(),
				ActionLibrary.FileActions.ExportActions.EXPORT_XSLT,
				ActionLibrary.FileActions.ExportActions.EXPORT_SUBMODEL,
				new JSeparator(),
				ActionLibrary.FileActions.ExportActions.EXPORT_WEB,
				new JSeparator(),
				ActionLibrary.FileActions.ExportActions.EXPORT_DATA
		);
	}
	...
	static class ViewSubMenus {
		...
		public static final JMenu TOOLBAR_MENU = createMenu(
				Tool3lgmConstants.getResString("toolbarMenu"),

				createCheckBoxItem(ActionLibrary.ViewActions.ToolbarActions.SWITCH_SHOW_PAINTING_BAR),
				createCheckBoxItem(ActionLibrary.ViewActions.ToolbarActions.SWITCH_SHOW_STANDARD_BAR)
		);
	}
	...
	public static class LayoutSubMenus {
		...
		public static final JMenu ELEMENT_LAYOUT_MENU = createMenu(
				...
				createMenu( // Transparenz-Menu
						Tool3lgmConstants.getResString("elementTransparencyMenu"),
						ActionLibrary.LayoutActions.ElementLayout.Transparency.NO,
						ActionLibrary.LayoutActions.ElementLayout.Transparency.SEMI,
						ActionLibrary.LayoutActions.ElementLayout.Transparency.FULL
				),
				createMenu( // Auf Standard setzen Menu
						Tool3lgmConstants.getResString("elementSetToStandardMenu"),
						ActionLibrary.LayoutActions.ElementLayout.RESET_FONT,
						ActionLibrary.LayoutActions.ElementLayout.RESET_COLOR,
						ActionLibrary.LayoutActions.ElementLayout.RESET_TRANSPARENCY,
				...
				createMenu( // Icon-Menu
						...
						ActionLibrary.LayoutActions.ElementLayout.Icon.NO_ICON,
						ActionLibrary.LayoutActions.ElementLayout.Icon.CHOOSE_ICON
				),
				new JSeparator(),
				createMenu( // Textausrichtungs-Menu (horizontal)
						Tool3lgmConstants.getResString("textAlignmentMenu"),

						ActionLibrary.LayoutActions.ElementLayout.TextAlignment.Horizontal.LEFT,
						ActionLibrary.LayoutActions.ElementLayout.TextAlignment.Horizontal.CENTER,
						ActionLibrary.LayoutActions.ElementLayout.TextAlignment.Horizontal.RIGHT,
						new JSeparator(),
						ActionLibrary.LayoutActions.ElementLayout.TextAlignment.Vertical.TOP,
						ActionLibrary.LayoutActions.ElementLayout.TextAlignment.Vertical.CENTER,
						ActionLibrary.LayoutActions.ElementLayout.TextAlignment.Vertical.BOTTOM
				)
		);

		/** Das Ebenen-Layout-Menu */
		public static final JMenu LAYER_LAYOUT_MENU = createMenu(
				Tool3lgmConstants.getResString("layerLayoutMenu"),

				ActionLibrary.LayoutActions.LayerLayout.RESET,
				ActionLibrary.LayoutActions.LayerLayout.CHANGE_COLOR,
				createMenu( // Transparenz-Menu
						Tool3lgmConstants.getResString("layerTransparencyMenu"),

						ActionLibrary.LayoutActions.LayerLayout.Transparency.NO,
						ActionLibrary.LayoutActions.LayerLayout.Transparency.SEMI,
						ActionLibrary.LayoutActions.LayerLayout.Transparency.FULL
				)
		);

		/** Das Level-Menu */
		public static final JMenu ELEMENT_LEVEL_MENU = createMenu(
				Tool3lgmConstants.getResString("levelMenu"),

				ActionLibrary.LayoutActions.Level.HIGHEST,
				ActionLibrary.LayoutActions.Level.INCREASE,
				ActionLibrary.LayoutActions.Level.DECREASE,
				ActionLibrary.LayoutActions.Level.LOWEST
		);

		/** Das Elemente-Ausrichtung-Menu */
		public static final JMenu ELEMENT_ALIGNMENT_MENU = createMenu(
				Tool3lgmConstants.getResString("elementAlignmentMenu"),
				ActionLibrary.LayoutActions.ElementAlignment.Horizontal.LEFT,
				ActionLibrary.LayoutActions.ElementAlignment.Horizontal.CENTER,
				ActionLibrary.LayoutActions.ElementAlignment.Horizontal.RIGHT,
				new JSeparator(),
				ActionLibrary.LayoutActions.ElementAlignment.Vertical.TOP,
				ActionLibrary.LayoutActions.ElementAlignment.Vertical.CENTER,
				ActionLibrary.LayoutActions.ElementAlignment.Vertical.BOTTOM,
				new JSeparator(),
				ActionLibrary.LayoutActions.ElementAlignment.Size.WIDTH,
				ActionLibrary.LayoutActions.ElementAlignment.Size.HEIGTH,
	...
	static class OptionsSubMenus {
		...
		public static final JMenu GENERAL_OPTIONS_MENU = createMenu(
				Tool3lgmConstants.getResString("general"),
				createCheckBoxItem(ActionLibrary.OptionsActions.Gerneral.SHOW_REMOVE_WARNING),
				createCheckBoxItem(ActionLibrary.OptionsActions.PartOf.CONSIDER_PARENTS),
				createCheckBoxItem(ActionLibrary.OptionsActions.PartOf.HIERARCHICAL)
		);

		/** Das Browser-Optionen-Menu */
		public static final JMenu BROWSER_OPTIONS_MENU = createMenu(
				Tool3lgmConstants.getResString("browserOptionsMenu"),

				createCheckBoxItem(ActionLibrary.OptionsActions.ModelBrowser.SUBMODEL_SPECIFIC),
				createCheckBoxItem(ActionLibrary.OptionsActions.ModelBrowser.SHOW_MULTIPLE_BROSERS),
//				createCheckBoxItem(ActionLibrary.ViewActions.SHOW_SUBMODELS_IN_BROWSER_SIDE_BY_SIDE),
				new JSeparator(),
				createCheckBoxItem(ActionLibrary.OptionsActions.ModelBrowser.USERDEFINED_PROPERTIES)
		);

		/** Das Grafik-Optionen-Menu */
		public static final JMenu GRAPHICS_OPTIONS_MENU = createMenu(
				Tool3lgmConstants.getResString("graphicOptionsMenu"),

				createCheckBoxItem(ActionLibrary.OptionsActions.Graphics.USE_RASTER),
				createCheckBoxItem(ActionLibrary.OptionsActions.Graphics.SHOW_RASTER),
...
//				createCheckBoxItem(ActionLibrary.OptionsActions.Graphics.UNUSED_INTERFACES),
				ActionLibrary.OptionsActions.Graphics.HIDE_UNASSOCIATED_INTERFACES,
				ActionLibrary.OptionsActions.Graphics.UNHIDE_ALL_INTERFACES,
				createCheckBoxItem(ActionLibrary.OptionsActions.Graphics.AUTOMATIC_COLORING),
				createCheckBoxItem(ActionLibrary.OptionsActions.PartOf.AUTO_MOVE_CHILDREN),
				createCheckBoxItem(ActionLibrary.OptionsActions.PartOf.SIGNIFY_COARSEMENT),
				ActionLibrary.OptionsActions.Graphics.ANALYSIS_COLOR,
	...
	static class ExtrasSubMenus {
		...
		public static final JMenu PLUGIN_MENU = createMenu(
				Tool3lgmConstants.getResString("plugin"), 
	...
	private static class FileMenu extends DynamicMenu {
		...
		public FileMenu() {
			...
			MenuCreator.addAll(this, 
					MenuCreator.createMenuEntries(true,
							ActionLibrary.FileActions.ACTION_NEW_MODEL,
							ActionLibrary.FileActions.OPEN,
							ActionLibrary.FileActions.SAVE,
							ActionLibrary.FileActions.SAVEAS,
							ActionLibrary.FileActions.CLOSE,
							new JSeparator(),
							ActionLibrary.FileActions.DESCRIPTION,
							new JSeparator(),
							...
							new JSeparator(),
							ActionLibrary.FileActions.EXIT
					)
			);
		}
		...
		public ViewMenu() {
			...
			MenuCreator.addAll(this, 
					MenuCreator.createMenuEntries(true,
							...
							createCheckBoxItem(ActionLibrary.ViewActions.SWITCH_SHOW_BROWSER),
							new JSeparator(),
							oneLayerPerspective,
							ActionLibrary.ViewActions.SHOW_DOMAIN_LAYER,
							ActionLibrary.ViewActions.SHOW_LOGICAL_TOOL_LAYER,
							ActionLibrary.ViewActions.SHOW_PHYSICAL_TOOL_LAYER,
							ActionLibrary.ViewActions.OPEN_LAYER_SETTINGS,
							new JSeparator(),
							ActionLibrary.ViewActions.OPEN_MATRIX
					)
			);
		}
	...
	public static class InsertMenu extends DynamicMenu {
		...
		protected void updateItems() {
			...
			switch(layerID) {
			case ModelConstants.DOMAIN_LAYER: MenuCreator.addAll(this, MENU_ENTRIES_DOMAIN);
			break;
			case ModelConstants.LOGICAL_LAYER: MenuCreator.addAll(this, MENU_ENTRIES_LOGICAL);
			break;
			case ModelConstants.PHYSICAL_LAYER: MenuCreator.addAll(this, MENU_ENTRIES_PHYSICAL);
			break;
			}
		}
	}
	...
	private static class WindowMenu extends DynamicMenu {
		...
		private int scrollItemCount = 30;
		
		public WindowMenu() {
			super(title);
			MenuCreator.addAll(this,
					MenuCreator.createMenuEntries(true,
							ActionLibrary.WindowActions.MODELS_PARALLEL_ARRANGEMENT,
							ActionLibrary.WindowActions.MODELS_OVERLAPPING_ARRANGEMENT,
							new JSeparator()
					)
			);
	...
	public static class HelpMenu extends JMenu {
		...
		public HelpMenu() {
			...
			MenuCreator.addAll(this, MenuCreator.createMenuEntries(false,
					new JSeparator(),
					ActionLibrary.HelpActions.EVALUATION,
					new JSeparator(),
					ActionLibrary.HelpActions.ONLINE_HELP,
					ActionLibrary.HelpActions.LGM_ONLINE,
					new JSeparator(),
					ActionLibrary.HelpActions.EXAMPLE,
					ActionLibrary.HelpActions.MODEL_LIBRARY,
					new JSeparator(),
					ActionLibrary.HelpActions.INFO,
					new JSeparator(),
					ActionLibrary.HelpActions.IMPORT_LICENSE
			));
		}
	}
