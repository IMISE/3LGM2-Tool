...
public class MenuCollection {
    ...
    public static final JMenu EXTRAS_MENU = createMenu("extras", ExtrasActions.ACTION_OPEN_USERFIELD_DEFINITION_DIALOG, ExtrasActions.ACTION_OPEN_USERFIELD_VALUE_EDITOR_DIALOG, Analysis.OPTION_ENABLE_CLASSIFICATION_NUMBER_CALCULATION, new JSeparator(),
            ModelConstants.getExtrasActions(false), new JSeparator(), BooleanProperty.OPTION_CHECK_CONSISTENCY, ExtrasSubMenus.PLUGIN_MENU);
    ...
    static class OptionsSubMenus {
        ...
        public static final JMenu GRAPHICS_OPTIONS_MENU = createMenu("graphicOptionsMenu", Graphics.OPTION_USE_RASTER, Graphics.OPTION_SHOW_RASTER, Graphics.OPTION_PAINT_EDGES_ONLY_FOR_SELECTED_ELEMENTS, Graphics.OPTION_SHOW_LINKED_WITH_SUBMODEL_SYMBOLS,
                Graphics.HIDE_UNHIDE_UNASSOCIATED, Graphics.OPTION_ASSIGN_CONFIGURATION_COLORS, PartOf.OPTION_GRAPH_MOVE_SUBELEMENTS, PartOf.TRANSIENT_OPTION_SHOW_EXPANSION_SIGN, Graphics.ANALYSIS_COLOR, Graphics.RENDERING_OPTIONS
