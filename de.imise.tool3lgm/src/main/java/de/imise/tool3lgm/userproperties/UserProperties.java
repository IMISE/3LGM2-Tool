...
*/
	 ...
	 */
	public static final Locale getLocale() {return locale;}
	/**
	 ...
	 * Das Umstellen der Locale hat nur Auswirkungen auf das sortieren der Elemente (siehe
	 * <code>Alphabetical.class</code>) und bei der Anzeige von Dialogen aus dem util-Package.
	 ...
	 * @param locale
	 */
	public static final Locale setLocale(Locale locale) {
		if (locale == null)
	 ...
	 */
	public static void setRenderingHints(int renderingHints) { 
	...
	/** @return showLinks */
	public static boolean isShowLinks()	{return showLinks;}
	/** @param b */
	public static void setShowLinks(boolean b) {showLinks = b;}
	...
	/** @return searchParts */
	public static boolean isSearchParts() {return searchParts;}
	/** @param b */
	public static void setSearchParts(boolean b) {searchParts = b;}
	...
	/** @return searchParts */
	public static boolean isSearchParents() {return searchParents;}
	/** @param b */
	public static void setSearchParents(boolean b) {searchParents = b;}
	...
	public static boolean isMoveSubelements() {return moveSubelements;}
	/** @param b */
	public static void setMoveSubelements(boolean b) {moveSubelements = b;}
	...
	public static boolean isEnableSubmodelBrowser() {return enableSubmodelBrowser;}
	/** @param b */
	public static void setEnableSubmodelBrowser(boolean b) {enableSubmodelBrowser = b;}
	...
	/**
	 * Wenn <code>true</code>, werden alle Modelbrowser nebeneinander angezeigt, bei <code>false</code>
	 * werden alle in einem TabPanel untergebracht.
	 ...
	 * werden alle in einem TabPanel untergebracht. 
	 */
	public static void setShowModelsInSeparateBrowser(boolean b) {
	 ...
	 * @param b
	 * /
	public static void setShowSubModelsInBrowserSideBySide(boolean b) {
	...
	public static boolean isShowUserDefinedPropertiesInModelBrowser() { return showUserDefinedPropertiesInModelBrowser; }
	/** @param b */
	public static void setShowUserDefinedPropertiesInModelBrowser(boolean b) { showUserDefinedPropertiesInModelBrowser = b; }
	...
	public static boolean isShowPartOfHierarchy() { return showPartOfHierarchy; }
	/** @param b */
	public static void setShowPartOfHierarchy(boolean b) {showPartOfHierarchy = b;}
	...
	public static boolean isUsePropertyColors() { return usePropertyColors; }
	/** @param usePropertyColors The usePropertyColors to set. */
	public static void setUsePropertyColors(boolean b) {usePropertyColors = b;}
	...
	/** @return useRaster */
	public static boolean isUseRaster() {return useRaster;}
	/** @param b */
	public static void setUseRaster(boolean b) {useRaster = b;}

	/** Wenn <code>true</code> wird in der Grafik das Raster gezeichnet. */
	private static boolean showRaster;
	/** @return showRaster */
	public static boolean isShowRaster() {return showRaster;}
	/** @param b */
	public static void setShowRaster(boolean b) {showRaster = b;}
	
	/** Rasterweite */
	private static int rasterWidth = 5;
	/** @param b */
	public static void setRasterWidth(int i) {rasterWidth = i;}
	/** @return	 rasterWidth*/
	public static int getRasterWidth() {return rasterWidth;}
	...
	public static boolean isAssignConfigurationColors() {return assignConfigurationColors;}
	/** @param b */
	public static void setAssignConfigurationColors(boolean b) {assignConfigurationColors = b;}
	...
	/** @param b */
	public static void setShowToolTips(boolean value) {showToolTips = value;}
	...
	public static boolean isNewSubmodelForAnalysis() {return newSubmodelForAnalysis;}
	/** @param b */
	public static void setNewSubmodelForAnalysis(boolean b) {newSubmodelForAnalysis = b;}
	...
	public static boolean isShowExpansionSign() {return showExpansionSign;}
	/** @param b */
	public static void setShowExpansionSign(boolean b) {showExpansionSign = b;}
	...
	public static boolean isShowABKonfigRedundance() {return showABKonfigRedundance;}
	/** @param b */
	public static void setShowABKonfigRedundance(boolean b) {showABKonfigRedundance = b;}
	...
	public static boolean isShowDataRedundance() {return showDataRedundance;}
	/** @param b */
	public static void setShowDataRedundance(boolean b) {showDataRedundance = b;}
	...
	public static boolean isShowMediumBreaks() {return showMediumBreaks;}
	/** @param b */
	public static void setShowMediumBreaks(boolean b) {showMediumBreaks = b;}
	 ...
	 */
	public static void addUsedFile(File file) {
	...
	public static ArrayList<File> getXSLSearchDirs() {return new ArrayList<File>(xslSearchDirs);}
	
	public static boolean addXslSearchDir(File file) {
	...
	public static boolean addAllXslSearchDir(Collection<File> fileList) {
	 ...
	 */
	public static void setUserHomePath(File path) { userHomePath = path; }
	 ...
	 */
	public static File getUserHomePath() { return userHomePath; }
	...
	public static boolean isEnableClassificationNumberCalculation() {return enableClassificationNumberCalculation;}
	
	/** @param b */
	public static void setEnableClassificationNumberCalculation(boolean b) {enableClassificationNumberCalculation = b;}
	...
	/** @param b */
	public static void setRMIRegistryPort(String b) {RMIRegistryPort = b;}
	
	/** @return	 RMIRegitryPort*/
	public static String getRMIRegistryPort() {return RMIRegistryPort;}
	...
	public static boolean isCheckConsistency() {return checkConsistency;}
	
	/** @param b */
	public static void setCheckConsistency(boolean b) {checkConsistency = b;}
	...
	public static boolean isShowRemoveWarning() {return showRemoveWarning;}
	
	/** @param b */
	public static void setShowRemoveWarning(boolean b) {showRemoveWarning = b;}
