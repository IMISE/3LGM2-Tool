...
public class XSLTFileHandler {
	 ...
	 */
	public static final FileNameExtensionFilterAndFileFilter XSLT_FILE_FILTER = new FileNameExtensionFilterAndFileFilter(Tool3lgmConstants.getResString("FILE_FILTER_XSL"), StringUtils.tokenize(Tool3lgmConstants.getResString("FILE_FILTER_XSL_EXT"), " ", false));
	
	/**
	 * fuegt alle XSLT-Files eines Verzeichnisses zur Tabelle hinzu
	 * @param path
	 */
	public static ArrayList<XSLTScript> getXSLTScripts(ArrayList<File> searchPath) {
	 ...
	 */
	public static String[] checkContent(File arg0) {
		if (!arg0.isFile())
			return null;
	 ...
	 * @return
	 */
	private static String[] check(RandomAccessFile file) {
		try {
			String[] attr = { "", "", "", "", "" };
			String line;
			int endIndex;
