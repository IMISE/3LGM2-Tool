...
/* --- swing anfang --- */
	 ...
	 */
	public XMLExportDialog(Frame owner, GDCollection collection) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("trans_delete") && selectedRow >= 0) {
			if (JOptionPane.showConfirmDialog(this,
				Tool3lgmConstants.getResString("quest_del") + "\n(" + tableModel.getValueAt(selectedRow, 0).toString() + ")", "",
		...
		if (e.getActionCommand().equals("trans_action") && selectedRow >= 0) {
			...
			if (selectedSzenarios.length == 0) return;
...
/* --- tabelle ende --- */
	...
	private class TableModel extends DefaultTableModel {
		...
		public String getColumnName(int column) {
			switch (column) {
				case 0: return Tool3lgmConstants.getResString("trans_file");
				case 1: return Tool3lgmConstants.getResString("trans_name");
				case 2:	return Tool3lgmConstants.getResString("trans_type");
				case 3: return Tool3lgmConstants.getResString("trans_des");
				case 4: return Tool3lgmConstants.getResString("trans_author"); 
				default: return null;
			}
		}
		 ...
		 * @return
		 */
		public XSLTScript getScript(int row) {
