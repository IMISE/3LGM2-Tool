 ...
 * <p>
 * Diese Klasse generiert automatisch über {@link #getAllActions()} die durch die Anzahl 
 * installierter Sprachen beschränkte Liste der möglichen Instanzen dieser Klasse. Jede dieser 
 * Instanzen sorgt für das Umschalten auf die jeweils zugeordnete Sprache.<br> 
 * Durch das Überschreiben von {@link #setSelected(boolean)} wird garantiert, dass nur genau
 * eine Sprache aktiviert ist. Diese Sprache ist dann unter {@link #selectedAction} abgespeichert
 * und besitzt als einziges den Wert <code>true</code> für die {@link #SELECTED_KEY}-Property.<p>
...
class ChangeLocaleAction extends StaticAction {
	 ...
	 */
	private ChangeLocaleAction(Locale locale) {
	...
	/* (non-Javadoc)
     * @see tool3lgm.util.event.ExtendedAction#setSelected(boolean)
     */
    @Override
