...
//			unused_interfaces,
	...
	/**
	 * Gibt den anzuzeigenden Text für die durch diesen Identifier identifizierte {@link StaticAction}
	 * wieder.
	 * @param 
	 */
	String getText() {
	...
	/**
	 * Gibt den {@link KeyStroke} zurück, der die durch diesen Identifier identifizierte {@link StaticAction}
	 * auslöst.
	 * @return
	 */
	...
	/**
	 * Gibt kurze Beschreibung der durch diesen Identifier identifizierten {@link StaticAction} zurück. 
	 * (Zur Verwendung als Tooltip)
	 * @param description
	 */
	String getShortDescription() {
		return null;
		//return Tool3lgmConstants.getDescription(name().concat(Tool3lgmConstants.SHORT_DESCRIPTION_SUFFIX));
	}
	
	/**
	 * Gibt ausführliche Beschreibung der durch diesen Identifier identifizierten {@link StaticAction} zurück. 
	 * (Zur Verwendung bei Hilfe)
	 * @param description
	 */
	String getLongDescription() {
		return null;
		//return Tool3lgmConstants.getDescription(name().concat(Tool3lgmConstants.LONG_DESCRIPTION_SUFFIX));
		
	}
	
	/**
	 * Gibt den command-<code>String</code> des {@link ActionEvent}s wieder, das
	 * beim Auslösen der durch <code>identifier</code> identifizierten {@link StaticAction} entsteht. 
	 * @param actionCommand
	 */
	...
	/**
	 * Liefert den zur {@link Locale} <code>l</code> gehörigen Identifier.<p>
	 * Per Konvention wird hier der Identifier zurückgegeben, der dem Namen von
	 * <code>l</code> im Englischen in Kleinbuchstaben entspricht.
	 * Bsp.: {@link Locale#GERMAN} --> {@link #german}
	 * 
	 * @param l
	 * @return
	 */
	static ActionIdentifier getIdentifierFor(Locale l) {
