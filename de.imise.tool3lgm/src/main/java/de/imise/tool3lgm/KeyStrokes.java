...
public class KeyStrokes {
    ...
    static {
        ...
        put(FileActions.ACTION_SAVE_MODEL_AS, KeyEvent.VK_U, MENU_SHORTCUT_KEY_MASK);
        put(FileActions.ACTION_CLOSE_ACTIVE_VIEW, KeyEvent.VK_W, MENU_SHORTCUT_KEY_MASK);
        put(FileActions.ACTION_EXIT, KeyEvent.VK_Q, MENU_SHORTCUT_KEY_MASK);
    ...
    private static void put(final GDCommands command, final int keyCode, final int modifiers) {
        ...
        command.setKeyStroke(keyStroke);
        KEYSTROKES.put(command.createAction(), keyStroke);
    }
