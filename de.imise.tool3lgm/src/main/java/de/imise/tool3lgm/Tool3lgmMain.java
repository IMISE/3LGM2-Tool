...
public class Tool3lgmMain {
	 ...
	 * @param args
	 * 		<table border="1">
	 * 			<th>Argument-Options</th>					<th>Usage</th></tr>
	 * 			<td>Visibility of the Tool</td>				<td><li><tt>"visible true"</tt>: Tool is visible
	 * 															<li><tt>"visible false</tt>: Tool is not visible</td></tr>
	 * 			<td>Relative of the Tool</td>				<td><li><tt>"visible true"</tt>: Tool is visible
	 * 		</table>
	 */
