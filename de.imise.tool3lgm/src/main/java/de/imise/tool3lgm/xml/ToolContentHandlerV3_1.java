...
public class ToolContentHandlerV3_1 extends ToolContentHandlerV3_0 {
	 ...
	 * @param coll
	 */
	public ToolContentHandlerV3_1(GDCollection coll) {
		super(coll);
	}

	/* (non-Javadoc)
	 * @see tool3lgm.xml.ToolContentHandlerV3_0#startElement(java.lang.String, java.lang.String, java.lang.String, org.xml.sax.Attributes)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see tool3lgm.xml.ToolContentHandlerV3_0#endElement(java.lang.String, java.lang.String, java.lang.String)
	 */
	@Override
	public void endElement(String namespaceURI, String localName, String qName)	throws SAXException {
		...
		//ab Version 4 gibt es diesen Faktor nicht mehr, sondern getrennte viewParameter.layerHeight und viewParameter.layerWidth 
			...
			if (!(szenario instanceof Szenario)) return;
