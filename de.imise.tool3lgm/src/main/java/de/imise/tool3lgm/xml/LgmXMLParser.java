...
public class LgmXMLParser extends DefaultHandler {
	...
	private StringBuilder elementTextBuf = new StringBuilder();
		...
		try {
			...
			if (rawName.equals("layout")) {
				...
				if (file_state == IN_MAPPING) {
					...
					// TODO:AXS:prüfen, warum das hier nur für Knoten passieren
					// muss
	 ...
	 * @return
	 */
	public LGMGraphDocument process(StringReader inputBuffer, LGMGraphDocument _doc, Hashtable<String, byte[]> imageTable, boolean loadIcons, boolean _select) {
	 ...
	 * @return
	 */
	public LGMGraphDocument process(StringReader inputBuffer, LGMGraphDocument _doc, Hashtable<String, byte[]> imageTable, boolean loadIcons) {
	 ...
	 * @return
	 */
	public LGMGraphDocument process(RandomAccessFile raf, LGMGraphDocument _doc, Hashtable<String, byte[]> iconTable, boolean loadIcons, boolean select) {
	 ...
	 * @return
	 */
	public static boolean isXMLFile(FileInputStream fileStream) {
		String line = "";
		try {
	...
	public static GraphDocument loadString(StringReader strBuffer, LGMGraphDocument _doc, Hashtable<String, byte[]> ImageTable, boolean loadIcons) {
	...
	public byte[] getIcon(Object o) {
		byte[] image = iconTable.get(o);
		return image;
	}

	public static boolean isXMLString(StringBuilder str) {
		return ((str.indexOf("<?xml") == 0) || (str.indexOf("<graph>") == 0));
	}

	public static LGMGraphDocument loadFile(RandomAccessFile raf, LGMGraphDocument _doc, Hashtable<String, byte[]> iconTable, boolean loadIcons, boolean select) {
		LgmXMLParser p = new LgmXMLParser();
