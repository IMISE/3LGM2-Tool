...
public class XMLInformationMessenger {
     ...
     */
    public static void showElementNoLongerSupportedMessage(final GDCollection gdcol, final Class<? extends ModelElement> elementClass, final boolean checkAlreadyShown) {
     ...
     * @param checkAlreadyShown
     */
    private static final void showAWBNotLongerSupportedMessage(final GDCollection gdcol, final boolean checkAlreadyShown) {
