...
/**
 * Stellt Funktionen bereit, mit denen konkrete Pfade zu definierten Metapfaden
...
public final class PathFinder {
	...
	/**
	 * Liste der Elementtypen, für die ein Pfad in init() definiert wurde (wird z.B.
	 * für die Comboboxen in der Matrixsicht gebraucht)
	 */
	...
	/**
	 * Liefert alle <code>MetaPath</code>es, die zwischen Elementen der Art <code>startClass</code> und <code>endClass</code>
	 * definiert sind.
	 *  
	 * @param startClass
	 * @param endClass
	 * @return
	 */
	public static final MetaPath[] getMetaPathes(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass) {
	 ...
	 * @param metaPath
	 * @param doc
	 * @return Doppelkante.NOTCONNECTED / Doppelkante.FORWARD /
	 *         Doppelkante.BACKWARD / Doppelkante.DOUBLE if path.isImmediate
	 *         otherwise Doppelkante.NOTCONNECTED / Doppelkante.DOUBLE
	 */
	public static final int isConnected(ModelElement element1, ModelElement element2, MetaPath metaPath) {
	 ...
	 * @return
	 */
	private static final int isConnected(ModelElement element1, ModelElement element2, MetaPath metaPath, boolean reverse) {
	...
	private static final int isConnected(ModelElement current, ModelElement end, MetaPath metaPath, int position, int pathIndex) {
	 ...
	 * @return
	 */
	public static final HashSet<ModelElement> getConnectedElements(ModelElement me, Class<? extends ModelElement>targetElementClass, MetaPath metaPath){
		HashSet<ModelElement> startElements = me.getParentElements();
		startElements.add(me);
		HashSet<ModelElement> endElements = null;
	 ...
	 * @return
	 */
	private static final String calculateKey(Class<? extends ModelElement> elementClass1, Class<? extends ModelElement> elementClass2) {
	 ...
	 * @param metaPath
	 */
	private static final void put(MetaPath[] metaPath) {
    ...
    private static final void init() throws InvalidPathException {
		...
		put(new MetaPath[] { 
			new MetaPath(
				Aufgabe.class, Objekttyp.class, 
				new Class[][] { { AufObjVerbindung.class } }, 
		...
		put(new MetaPath[] { 
			new MetaPath(
				Aufgabe.class, Aufgabe.class, 
				new Class[][]{{AufAufVerbindung.class}}, 
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true
			) 
		});
		...
		put(new MetaPath[] { 
			new MetaPath(
				Aufgabe.class, Organisationseinheit.class, 
				new Class[][]{{AufAufOrgVerbindung.class, OrgAufOrgVerbindung.class}}, 
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, Anwendungsbaustein.class, 
				new Class[][]{{AufAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class}}, 
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, RechAnwendungsbaustein.class,
				new Class[][]{{AufAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class}},
				s("Aufgabe") + " " + s("text_unterstuetzt") + " " + s("Anwendungsbaustein")
			) 
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, KonAnwendungsbaustein.class,
				new Class[][]{{AufAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class}},
				s("Aufgabe") + " " + s("text_unterstuetzt") + " " + s("Anwendungsbaustein")
			) 
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, PhysischerDVBaustein.class,
				new Class[][] {{AufAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class, PdvbkAwbVerbindung.class, PdvbPdvbkVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, Standort.class,
				new Class[][]{{AufAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class, PdvbkAwbVerbindung.class, PdvbPdvbkVerbindung.class, PdvbStoVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, Datensatztyp.class,
				new Class[][]{{ObjReprVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, Dokumententyp.class,
				new Class[][]{{ObjReprVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, Nachrichtentyp.class,
				new Class[][]{{ObjReprVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, Dokumentensammlung.class,
				new Class[][]{{ObjLogspVerbindung.class}},
		...
		put(new MetaPath[] { 
			new MetaPath(
				Objekttyp.class, Datenbanksystem.class,
				new Class[][]{{ObjLogspVerbindung.class}},
				s("Objekttyp") + " " + s("text_fuehrend") + " " + s("Datenbanksystem")
			),  
			new MetaPath(
				Objekttyp.class, Datenbanksystem.class,
				new Class[][]{{ObjReprVerbindung.class, DbsDatVerbindung.class,}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, Softwareprodukt.class,
				new Class[][]{{SwpAufVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Aufgabe.class, Ereignistyp.class,
				new Class[][]{{EtAufVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Anwendungsbaustein.class, Bausteinschnittstelle.class,
				new Class[][]{{AwbKommssVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, Bausteinschnittstelle.class,
				new Class[][]{{AwbKommssVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_besitzt") + " " + s("Bausteinschnittstelle")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, Bausteinschnittstelle.class,
				new Class[][]{{AwbKommssVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_besitzt") + " " + s("Bausteinschnittstelle")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				Anwendungsbaustein.class, Benutzungsschnittstelle.class,
				new Class[][]{{AwbKommssVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_besitzt") + " " + s("Bausteinschnittstelle")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, Benutzungsschnittstelle.class,
				new Class[][]{{AwbKommssVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_besitzt") + " " + s("Bausteinschnittstelle")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, Benutzungsschnittstelle.class,
				new Class[][]{{AwbKommssVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_besitzt") + " " + s("Bausteinschnittstelle")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, Datenbanksystem.class,
				new Class[][]{{RawbDbsVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, Dokumentensammlung.class,
				new Class[][]{{KawbDoksVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Anwendungsbaustein.class, PhysischerDVBaustein.class,
				new Class[][]{{PdvbkAwbVerbindung.class, PdvbPdvbkVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, PhysischerDVBaustein.class,
				new Class[][]{{PdvbkAwbVerbindung.class, PdvbPdvbkVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_installiert") + " " + s("PhysischerDVBaustein")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, PhysischerDVBaustein.class, 
				new Class[][]{{PdvbkAwbVerbindung.class, PdvbPdvbkVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_installiert") + " " + s("PhysischerDVBaustein")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				Organisationseinheit.class, Organisationseinheit.class,
				new Class[][]{{OrgOrgVerbindung.class}},
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true)
			}
		);
		...
		put(new MetaPath[] {
			new MetaPath(
				Organisationseinheit.class, PhysischerDVBaustein.class,
				new Class[][]{{OrgAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class, PdvbkAwbVerbindung.class, PdvbPdvbkVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Organisationseinheit.class, Anwendungsbaustein.class,
				new Class[][]{{OrgAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Organisationseinheit.class, RechAnwendungsbaustein.class,
				new Class[][]{{OrgAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class}},
				s("Organisationseinheit") + " " + s("text_benutzt") + " " + s("Anwendungsbaustein")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				Organisationseinheit.class, KonAnwendungsbaustein.class,
				new Class[][]{{OrgAufOrgVerbindung.class, AwbkAufOrgVerbindung.class, AwbAwbkVerbindung.class}},
				s("Organisationseinheit") + " " + s("text_benutzt") + " " + s("Anwendungsbaustein")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, Objekttyp.class,
				new Class[][]{{ObjObjVerbindung.class}},
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true)
			}
		);
		...
		put(new MetaPath[] {
			new MetaPath(
				...
				new Class[][]{{SubnNetzpVerbindung.class}},
		...
		/* Subnetz - Netztyp */
		put(new MetaPath[] {
			new MetaPath(Subnetz.class, Netztyp.class,
				new Class[][]{{SubnNetztVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				PhysischerDVBaustein.class, Subnetz.class,
				new Class[][]{{PdvbSubnVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				PhysischerDVBaustein.class, Standort.class,
				new Class[][]{{PdvbStoVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				PhysischerDVBaustein.class, Bausteintyp.class,
				new Class[][]{{PdvbBtypVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				PhysischerDVBaustein.class, PhysischerDVBaustein.class,
				new Class[][]{{PdvbPdvbVerbindung.class}},
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true
			),
			new MetaPath(
				PhysischerDVBaustein.class, PhysischerDVBaustein.class,
				new Class[][]{{DatenuebertragungsVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Organisationseinheit.class, Softwareprodukt.class, 
				new Class[][]{
		...
		put(new MetaPath[] {
			new MetaPath(
				Anwendungsbaustein.class, Kommunikationsstandard.class,
				new Class[][]{{AwbKommssVerbindung.class, BssKommstVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, Kommunikationsstandard.class,
				new Class[][]{{AwbKommssVerbindung.class, BssKommstVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_benutzt") + " " + s("Kommunikationsstandard")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, Kommunikationsstandard.class,
				new Class[][]{{AwbKommssVerbindung.class, BssKommstVerbindung.class}},
				s("Anwendungsbaustein") + " " + s("text_benutzt") + " " + s("Kommunikationsstandard")
			)
		});
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, Softwareprodukt.class,
				new Class[][]{{RawbAwpVerbindung.class, AwpSwpVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, Organisationsplan.class,
				new Class[][]{{KawbOrgpVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, RechAnwendungsbaustein.class,
				new Class[][]{{ObjLogspVerbindung.class, RawbDbsVerbindung.class}},
				s("Objekttyp") + " " + s("text_fuehrenden") + " " + s("Anwendungsbaustein")
			),
			new MetaPath(
				Objekttyp.class, RechAnwendungsbaustein.class,
				new Class[][]{{ObjReprVerbindung.class, DbsDatVerbindung.class, RawbDbsVerbindung.class}},
		...
		put(new MetaPath[] {
			new MetaPath(
				Objekttyp.class, KonAnwendungsbaustein.class,
				new Class[][]{{ObjLogspVerbindung.class, KawbDoksVerbindung.class}},
				s("Objekttyp") + " " + s("text_fuehrenden") + " " + s("Anwendungsbaustein")
			),
			new MetaPath(
				Objekttyp.class, KonAnwendungsbaustein.class,
				new Class[][]{{ObjReprVerbindung.class, DoksDokVerbindung.class, KawbDoksVerbindung.class}},
				s("Objekttyp") + " " + s("text_speichert") + " " + s("Anwendungsbaustein")
			),
			new MetaPath(
				Objekttyp.class, KonAnwendungsbaustein.class,
		...
		put(new MetaPath[] {
			new MetaPath(
				Anwendungsbaustein.class, Anwendungsbaustein.class,
				new Class[][]{
			...
			new MetaPath(
				Anwendungsbaustein.class, Anwendungsbaustein.class,
				new Class[][]{{AwbKommssVerbindung.class, KommBeziehung.class, AwbKommssVerbindung.class}},
				new Color[]{Color.ORANGE, Color.BLUE, Color.GREEN },
				new String[] {
		...
		put(new MetaPath[] {
			new MetaPath(
				RechAnwendungsbaustein.class, RechAnwendungsbaustein.class,
				new Class[][]{{RawbRawbVerbindung.class}},
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true
			),
			new MetaPath(
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, Anwendungsbaustein.class,
				new Class[][]{{AwbKawbVerbindung.class}},
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true
			),
			new MetaPath(
		...
		put(new MetaPath[] {
			new MetaPath(
				KonAnwendungsbaustein.class, KonAnwendungsbaustein.class,
				new Class[][]{{AwbKawbVerbindung.class}},
				s("zeile") + " " + s("text_teil_von") + " " + s("spalte"),
				true
			),
	 ...
	 * @return
	 */
	private static final String s(String resourceString) {
