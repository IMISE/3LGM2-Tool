...
public class ElementSelectionContext {
	 ...
	 * @return
	 */
	public final boolean isSelected(ElementContainer ec) {
	 ...
	 */
	public final void addSimpleToSelection(ElementContainer mc) {
		if (mc == null)
			return;
	 ...
	 * @param me
	 */
	protected final void deselectInElementSelectionContext(ModelElement me) {
		if (me == null)
			return;
	...
	/**
	 * Liefert <code>true</code>, wenn mind. ein {@link NodeContainer} selektiert ist.
	 * {@link BendpointContainer} als Unterklasse von {@link NodeContainer} zählen auch. 
	 * 
	 * @return
	 */
	...
	/**
	 * Liefert <code>true</code>, wenn mind. ein {@link NodeContainer} selektiert ist, der kein
	 * {@link BendpointContainer} ist.
	 *  
	 * @return
	 */
	...
	/**
	 * Liefert <code>true</code>, wenn nur {@link NodeContainer} selektiert sind, die keine
	 * {@link BendpointContainer} sind.
	 *  
	 * @return
	 */
