...
public class LGMGraphDocument extends GraphDocument {
     ...
     * @param pid
     */
    public final void changeOSType(final String hashString, String osType, final int pid) {
     ...
     * @param pid
     */
    public final void changeOSType(final String osType, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
     ...
     * @param pid
     */
    public final void changeSerial(final String hashString, String serial, final int pid) {
        ElementContainer mc = findNodeContainerCoded(hashString);
        ModelElement me = mc.getElement();
        if (!(me instanceof PhysischerDVBaustein)) {
            return;
     ...
     * @param pid
     */
    public final void changeSerial(final String serial, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
     ...
     * @param pid
     */
    public final void changeInventar(final String hashString, String inventar, final int pid) {
        ElementContainer mc = findNodeContainerCoded(hashString);
        ModelElement me = mc.getElement();
        if (!(me instanceof PhysischerDVBaustein)) {
            return;
     ...
     * @param pid
     */
    public final void changeInventar(final String inventar, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
     ...
     * @param pid
     */
    public final void changeRamSize(final String hashString, String ramSize, final int pid) {
        ElementContainer mc = findNodeContainerCoded(hashString);
        ModelElement me = mc.getElement();
        if (!(me instanceof PhysischerDVBaustein)) {
            return;
     ...
     * @param pid
     */
    public final void changeRamSize(final String ramSize, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
     ...
     * @param pid
     */
    public final void changeDiskSize(final String hashString, String diskSize, final int pid) {
        ElementContainer mc = findNodeContainerCoded(hashString);
        ModelElement me = mc.getElement();
        if (!(me instanceof PhysischerDVBaustein)) {
            return;
     ...
     * @param pid
     */
    public final void changeDiskSize(final String diskSize, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
     ...
     * @param pid
     */
    public final void changeProcessor(final String hashString, String processor, final int pid) {
        ElementContainer mc = findNodeContainerCoded(hashString);
        ModelElement me = mc.getElement();
        if (!(me instanceof PhysischerDVBaustein)) {
            return;
     ...
     * @param pid
     */
    public final void changeProcessor(final String processor, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
     ...
     * @param pid
     */
    public final void changeDowntime(final String hashString, String downtime, final int pid) {
        ElementContainer mc = findNodeContainerCoded(hashString);
        ModelElement me = mc.getElement();
        if (!(me instanceof PhysischerDVBaustein)) {
            return;
     ...
     * @param pid
     */
    public final void changeDowntime(final String downtime, final int pid) {
        start_transaction(pid);
        for (ElementContainer ec : selectedContainer) {
