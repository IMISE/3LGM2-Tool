...
public final class KnotenRenderer {
	...
	public static final void render(Graphics g, NodeContainer kc, GraphDocument doc){
...
//			System.out.println(northLabel.getText() + "\nnorthLabel.height="+northLabel.getPreferredSize().height + " northLabel.width="+northLabel.getPreferredSize().width);
	 ...
	 * @return
	 */
	public static final boolean isInside(ElementContainer ec, double xi, double yi) {
	 ...
	 * <p>Rückgabewerte:
	 * <ul>
	 * <li><code>Cursor.DEFAULT_CURSOR</code>: Koordinaten sind ausserhalb eines der 
	 * 		anderen speziellen Grenzbereiche</li>
	 ...
	 */
	public static final int getResizeCursor(NodeContainer container, int xi, int yi) {
