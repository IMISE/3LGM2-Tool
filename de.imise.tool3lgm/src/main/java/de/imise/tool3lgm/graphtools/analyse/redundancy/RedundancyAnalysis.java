...
public class RedundancyAnalysis extends WindowAdapter {
    ...
    public static final void getReport(final GDCollection gdcoll) {
        ...
        do {
            ...
            for (int i = 0; i < analyseCount; i++) {
                ...
                IMetaPath metaPath = singleRedundancyAnalysisDefinition.getMetaPath();
            ...
            if (result == null && selectedOptions.get(selectedOptions.size() - 1) != null) {
                ...
                if (mps.isValidSelection()) {
                    ...
                    List<IMetaPath> selectedMetaPaths = metaPathSelection.selectedMetaPaths;
                    IMetaPath mp = selectedMetaPaths.get(0); //es solte genau einer sein
                    IMetaPath metaPath = WrapperMetaPath.wrapMetaPath(c1, c2, mp);
    ...
    private static String getElementName(final ModelElement me, final SingleRedundancyAnalysisDefinition analysisDefinition) {
        ...
        IMetaPath expandedNamePath = analysisDefinition.getExpandedNamePath(me.getClass());
