...
/**
 * @author AXS created on 20.07.2007
 */
...
public class AufOrgPanel extends LGMDragNDropPanel {
    ...
    private final JScrollPane spl, spr;
    ...
    public AufOrgPanel(final Class<? extends ModelElement> elementClass, final ElementPropertyDialog dl, final boolean mitnew) {
        super(dl);
        ...
        try {
            addAction = LGMActionLibrary.getAddElementAction(rtree, ltree, this, true);
            removeAction = LGMActionLibrary.getDisconnectAction(ltree, rtree, this, false);
            newElementAction = LGMActionLibrary.getNewElementAction(this, this.elementClass);
        }
