...
public class SerialMetaPath extends ListMetaPath {
    ...
    public boolean equals(final Object obj) {
        ...
        //do not compare the direction! The direction is only for the name but
        //if the name is generated by a sub elementary metapath the the direction
        //is irrelevant. So only compare the name.
