 ...
 * von Aufgaben bzw. Objekttypen geht auch.
 */
public class OTAPanel extends LGMDragNDropPanel {
	

	private LGMDragNDropTree otree, utree;
	private LGMDragNDropTree rotree, rutree;
	private DefaultTreeModel omodel, umodel, romodel, rumodel;
	private LGMTreeNode oroot, uroot, roroot, ruroot;
	private JPanel buttonpanel1, buttonpanel2;
	private JLabel oben2, unten2;
	...
	public OTAPanel(Class<? extends ModelElement> searchElementClass, ElementPropertyDialog pd) {
		super(pd);
	...
	protected DragNDropActionChain[] collectDragNDropActionChains() {
		DragNDropActionChain tac1 = DragNDropInitializer.createNewDragNDropActionChain(this.rotree, this.otree,this.addUeberAction);
		DragNDropActionChain tac2 = DragNDropInitializer.createNewDragNDropActionChain(this.otree, this.rotree,this.removeUeberAction);
		DragNDropActionChain tac3 = DragNDropInitializer.createNewDragNDropActionChain(this.rutree, this.utree,this.addUnterAction);
		DragNDropActionChain tac4 = DragNDropInitializer.createNewDragNDropActionChain(this.utree, this.rutree,this.removeUnterAction);
