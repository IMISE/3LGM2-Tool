...
public class ETNTPanel extends LGMDragNDropPanel {
	...
	public ETNTPanel(Class<? extends ModelElement> searchElementClass, ElementPropertyDialog dl) {
		super(dl);
		...
		try {
			final LGMAction addAction1 = LGMActionLibrary.getAddElementAction(this.rotree,this.otree,this,true);
			final LGMAction addAction2 = LGMActionLibrary.getAddElementAction(this.rutree,this.utree,this,false);
			...
			final LGMAction removeAction1 = LGMActionLibrary.getDisconnectAction(this.otree,this.rotree,this,true);
			final LGMAction removeAction2 = LGMActionLibrary.getDisconnectAction(this.utree,this.rutree,this,false);
...
*/
	...
	protected DragNDropActionChain[] collectDragNDropActionChains() {
		DragNDropActionChain tac1 = DragNDropInitializer.createNewDragNDropActionChain(this.rotree, this.otree,this.addAction);
		DragNDropActionChain tac2 = DragNDropInitializer.createNewDragNDropActionChain(this.otree, this.rotree,this.removeAction);
		DragNDropActionChain tac3 = DragNDropInitializer.createNewDragNDropActionChain(this.rutree, this.utree,this.addAction);
		DragNDropActionChain tac4 = DragNDropInitializer.createNewDragNDropActionChain(this.utree, this.rutree,this.removeAction);
	...
	public LGMDragNDropTree[] getAllDragNDropTrees() {
		return new LGMDragNDropTree[]{this.otree, this.rotree, this.utree, this.rutree};
	}
