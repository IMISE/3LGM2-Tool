...
/**
 * Diese Klasse stellt 3 zusammengehörige Komponenten bereit, mit denen ein Benutzter
 * einen speziellen Metapfad auswählen kann.<br> 
 * In die erste ComboBox kann man eine Klasse des Meta-Pfades eingeben, in die zweite
 * die andere Klasse und, falls es zw. diesen Klassen mehrere MetaPfade gibt, kann man
 * aus einer Liste einen auswählen.<br>
...
public class MetaPathSelector implements ActionListener{
	 ...
	 */
	private AlphabeticalComboBox class1ComboBox;
	
	/**
	 * ComboBox für die zweite Klasse
	 */
	private AlphabeticalComboBox class2ComboBox;
	
	/**
	 * Listenkomponente zur Auswahl des Metapfades zwischen den in den ComboBoxen
	...
	/**
	 * Selektor der in allen Dialigen benutzt wird, die statisch von dieser Klasse
	 * angezeigt werden. Dadurch bleibt eine alte Auswahl immer erhalten.
	 */
	...
	/**
	 * Gibt einen neuen <code>MetaPathSelector</code>, für den alle Komponenten
	 * initialisiert sind, zurück.
	 * 
	 ...
	 * @return einen <code>MetaPathSelector</code> der durch die Einträge aus einem 
	 * 			angezeigten Dialog gefüllt wurde
	 */
	 ...
	 * 			angezeigten Dialog gefüllt wurde
	 */
	public static final MetaPathSelector showDialog(String class1Label, String class2Label, String metaPathListLabel){
	 ...
	 * @param e
	 */
	private void deliverChangeEvent(Object source) {
