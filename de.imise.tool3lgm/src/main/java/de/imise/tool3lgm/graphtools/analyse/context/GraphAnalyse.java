...
public class GraphAnalyse {
	 ...
	 * @return
	 */
	public static List<ElementContainer> performSearch(GraphDocument doc, List<String> typ, boolean getVerbundenState, List<String> connectedNames) {
	 ...
	 * @return
	 */
	public static List<ElementContainer> searchWithinConnected(GraphDocument doc, List<ElementContainer> origin, List<ElementContainer> exclude, List<String> typ, boolean getVerbundenState, List<String> connectedNames, boolean searchParts, boolean searchParents) {
	 ...
	 * @return
	 */
	private static boolean matchesCriteria(GraphDocument doc, ElementContainer ec, boolean verbundenState, List<String> connectedNames) {
