 ...
 * <code>JTextField</code>,<code>JTextArea</code>, Kennzahl,
 * KennzahlFormel, Verteilungsgewicht), ein Zahlenformat und Einheit zugeordnet.
 * 
...
public final class UserFieldDefinitionDialog extends PropertyDialog implements ActionListener {
	 ...
	 */
	private ArrayList<AbstractInputPanel> panelList = new ArrayList<AbstractInputPanel>();
	...
	/**
	 * Rückgabewert des Dialoges. Er nimmt einen der Werte UserFieldDefinitionDialog.OK
	 * oder UserFieldDefinitionDialog.CANCEL an
	 */
	 ...
	 * @param gdcol
	 */
	private UserFieldDefinitionDialog(JDialog owner, UserField userField, GDCollection gdcol) {
		super(owner, gdcol);
	 ...
	 */
	public static int showDialog(JDialog owner, UserField userField, GDCollection gdcol) {
