...
public class ConnectedElementsTableDefinition implements Iterable<SingleColumnDefinition> {
    ...
    public static class SingleColumnDefinition {
        ...
        /**
         * Art der Spalte - also welche genaue Information des in dieser Spalte anzuzeigenden Pfadschrittes dargestellt werden soll (z.B. Name des
         * Endelementes, Name der Kante in einer bestimmten Richtung oder Optionalität einer {@link OptionalEdge} im Pfadschritt oder ...
         */
        private final ColumnType columnType;

        /** Index des Pfadschrittes, von dem eine Eigenschaft in der Spalte dargestellt wird. */
        private final int pathStepIndex;

        /** Optionaler Parameter, der den Default-Spatennamen mir einem Resourcenstring überschreibt */
        private final String headerResKeyOrName;

        /**
         * preferredWidth der Spalte (muss man auch im Verhältnis zu den anderen Spalten und deren preferredWidth sehen). Kann man setzten, wenn einge
         * Spalten breiter als andere sein sollen. Default ist, dass alle gleich breit sind.
         */
        private final int width;

        /**
         * @param columnType
         *            Art der Spalte - also welche genaue Information des in dieser Spalte anzuzeigenden Pfadschrittes dargestellt werden soll (z.B.
         *            Name des Endelementes, Name der Kante in einer bestimmten Richtung oder Optionalität einer {@link OptionalEdge} im Pfadschritt
         *            oder ...
         * @param pathStepIndex
         *            Index des Pfadschrittes, von dem eine Eigenschaft in der Spalte dargestellt wird.
    ...
    /**
     * Liste alle Einzelspaltendefinitionen. Das ist die Reihenfolge, in der die Tabellenspalten initial erzeugt werden.
     */
    private final List<SingleColumnDefinition> columnDefinitions = new ArrayList<>();

    /**
     * Fügt eine Spalte zur Definition hinzu, die die Endelemente der gefundenen Pfade anzeigt.
     *
     * @param width
     *            preferredWidth der Spalte (muss man auch im Verhältnis zu den anderen Spalten und deren preferredWidth sehen). Kann man setzten,
     *            wenn einge Spalten breiter als andere sein sollen. Default ist, dass alle gleich breit sind.
    ...
    /**
     * Fügt eine Spalte zur Definition hinzu, die die Optional-Eigenschaft einer {@link OptionalEdge} anzeigt. Der Spaltenkopf ist der Anzeigename der
     * gemeinsamen Oberklasse aller Endklassen aller übergebenen {@link SimpleMetaPath}
     *
     * @param index
     *            Index der {@link OptionalEdge} im Pfad
     * @param width
     *            preferredWidth der Spalte (muss man auch im Verhältnis zu den anderen Spalten und deren preferredWidth sehen). Kann man setzten,
     *            wenn einge Spalten breiter als andere sein sollen. Default ist, dass alle gleich breit sind.
     */
     ...
     *            {@link #addColumnPathStepName(int, int)}
     * @param width
     *            preferredWidth der Spalte (muss man auch im Verhältnis zu den anderen Spalten und deren preferredWidth sehen). Kann man setzten,
     *            wenn einge Spalten breiter als andere sein sollen. Default ist, dass alle gleich breit sind.
     */
    ...
    /**
     * Fügt eine Spalte zur Definition hinzu, die den Namen des Elementarpfades anzeigt - also nur den Kantennamen in der durch den Pfad festgelegten
     * Rückwärts-Richtung. Der Spaltenkopf wird aus allen Kantennamen jeweils durch " / " getrennt gebildet.
     *
     * @param index
     *            Index des Elementarpfades im Pfad
     * @param width
