 ...
 * und {@link Anwendungsbaustein}e darstellt. <p>
...
public class InterLayerConnectedNodeContainer extends NodeContainer {
	 ...
	 * @param doc
	 */
	public InterLayerConnectedNodeContainer(Knoten neu, GraphElementLayout l, GraphDocument doc) {
	    super(neu, l, doc);
	    init(doc);
    }
	 ...
	 * @param doc
	 */
	public InterLayerConnectedNodeContainer(NodeContainer alt, GraphDocument doc) {
	    super(alt, doc);
	    init(doc);
    }
	 ...
	 * @param doc
	 */
	public InterLayerConnectedNodeContainer(Knoten k, GraphDocument doc) {
	    super(k,doc);
	    init(doc);
    }
	 ...
	 * @param doc
	 */
	protected void init(GraphDocument doc) {
     ...
     * @param doc
     */
    public void setShowInterLayerConnections(boolean show) {
		this.showInterLayerConnections = show;
