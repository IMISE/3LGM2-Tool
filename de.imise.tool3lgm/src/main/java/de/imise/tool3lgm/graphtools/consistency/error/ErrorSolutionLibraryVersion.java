...
public class ErrorSolutionLibraryVersion {
	...
	private static Class[][] abKonfigToAufgabeEdgeClasses = {{AwbkAufOrgVerbindung.class, AufAufOrgVerbindung.class}};
	@SuppressWarnings("rawtypes")
    private static Class[][] abKonfigToAnwendungsbausteinEdgeClasses = {{AwbAwbkVerbindung.class}};
	@SuppressWarnings("rawtypes")
    private static Class[][] dbKonfigToAnwendungsbausteinEdgeClasses = {{PdvbkAwbVerbindung.class}};

    
	/**
	 * Falls man mal verschiedene Metamodelle gleichzeitug nutzen will, muss man für
	 * jede Metamodellversion eine eigene Klasse mit Lösungen anlegen. Daher kann man
	 * die Lösungen nicht einfach statisch abfragen.
	 */
	...
	/*
	wenn man keine Error-Solution für einen Min oder Max-Fehler findet, wird ein neues OneToNUndirectedConnectionPanel angefügt, das den Fehler anzeigt
	wenn die minimale Kardinalität eines initalSubTypes unterschritten ist, dann einfach einen neuen anlegen (Anwendungsparogramm bei AWB, Orgplan bei KAWB)
...
//		BssKommstVerbindung.class, Bausteinschnittstelle.class, nur max
	 ...
	 * @return
	 * /
	private final Pair[] MINCARDINALITY_NO_SOLUTION_ERRORS = {
		new Pair<Class<? extends ModelElement>, Class<? extends Kante>>(DBKonfiguration.class, PdvbkAwbVerbindung.class),		
		new Pair<Class<? extends ModelElement>, Class<? extends Kante>>(ABKonfiguration.class, AwbkAufOrgVerbindung.class),		
	};
	 ...
	 * @return
	 */
	public final ErrorSolution getSolution(CardinalityError error){
	 ...
	 * @return
	 * /
	public final Pair<Class<? extends ModelElement>, Class<? extends Kante>>[] getMinCardinalityNoSolutuinErrors(){
