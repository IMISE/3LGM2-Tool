...
public class KomPanel extends LGMDragNDropPanel {
    ...
    private final DefaultTreeModel omodel, romodel;
    private final LGMTreeNode oroot, roroot;
    private JLabel oben;
    ...
    public KomPanel(final Class<? extends ModelElement> searchElementClass, final ElementPropertyDialog pd, final boolean editable) {
        super(pd);
