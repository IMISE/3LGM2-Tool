...
public abstract class CardinalityError extends Error {
	...
	/**
	 * Klasse der Verbindungen, deren Instanzanzahl für das Modellelement zu hoch oder zu niedrig ist.
	 */
	 ...
	 * @param gdcoll
	 */
	public CardinalityError(ModelElement me, Class<? extends Kante> edgeClass, int cardValue, GDCollection gdcoll) {
		super();
		this.me = me;
    ...
    public boolean equals(Object obj) {
		...
		if (this.me!=ce.me || this.cardValue!=ce.cardValue || this.edgeClass!=ce.edgeClass)
			return false;
        return true;
    }
	
	/**
	 * Liefert den StringBuilder der die toString()-Message zusammenbaut. Unterklassen können so noch
	 * etwas hinzufügen.
	 * 
	 * @return
	 */
