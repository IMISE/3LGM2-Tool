...
public class BendpointContainer extends NodeContainer {
	...
	public BendpointContainer(Knickpunkt kp, GraphDocument gd) {
	...
	/* (non-Javadoc)
	 * @see tool3lgm.graphtools.view.container.NodeContainer#refreshText()
	 */
	@Override
	...
	/**
	 * Liefert den Punkt, an dem sich der Knickpunkt vor diesem befindet. Ist es der erste Knickpunkt
	 * dieser Kante, dann kommt der Startpunkt der Kante zurück.
	 * 
	 * @param bc
	 * @return
	 */
	...
	/**
	 * Liefert den Punkt, an dem sich der Knickpunkt nach diesem befindet. Ist es der letzte Knickpunkt
	 * dieser Kante, dann kommt der Endpunkt der Kante zurück.
	 * 
	 * @param bc
	 * @return
	 */
