...
public class ReferencePanel extends JPanel implements ActionListener {
	...
	/**
	 * die Klasse der Kante, zu der die gebunden Elemente und wiederum deren
	...
	/**
	 * Wenn die Kante eine Teil-Von Beziehung ist, wird dieses Panel angezeigt.
	 * Darin befinden sich die Radion Button zum Kennzeichen der Richtung
	 */
	private JPanel directionPanel;

	/**
	 * Wenn die Kante eine Teil-Von Beziehung ist, kann der RadioButton die
	 ...
	 * @param userField
	 */
	public ReferencePanel(UserField userField) {
		super();
		this.edgeClass = userField.getTargetClass().asSubclass(Kante.class);
	 ...
	 * @param classesList
	 */
	private void setClassesInLists(AlphabeticalJList classesList) {
		for (int i = 0; i < classes.length; i++) {
