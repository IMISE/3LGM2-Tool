 ...
 * <p>
 * Die Dateneingabe erfolgt für jede Klasse von Kantenelementen und jedes für sie
 * definierte Verteilungsgewicht separat - die Auswahl der Klasse erfolgt in der 
 * enthaltenen <code>edgeBox</code>, die Auswahl des Verteilungsgewichtes in der
 * <code>weightBox</code>.
 * 
 * @author fstephan
 */
public class DistributionWeightEditorPanel extends UserFieldEditorPanel {
	...
	/**
	 * Auswahlbox für die Verteilungsgewichte des in <code>edgeBox</code> ausgewählten
	 * Kantentyps
	 */
	 ...
	 */	
	public DistributionWeightEditorPanel(UserFieldEditorDialog dialog) {
		super(dialog);
		initEdgeBox();
		initWeightBox();
	}
	...
	/**
	 * Methode setzt den Inhalt der <code>edgeBox</code>
	 * Es werden nur Kantenklassen hinzugefügt, für die ein Verteilungsgewicht definiert
	 * ist.
	 */
	 ...
	 * <code>edgeBox</code>.
	 * 
	 * Werte im Table werden temporär übernommen und die zur gewählten Kantenart
	 * gehörigen Verteilungsgewichte in die <code>weightBox</code> eingefügt.
	 */
	private void setActionsForEdgeBox() {
		...
		/*
		 * Bei Änderung der Auswahl in edgeBox, werden in der weightBox die verfügbaren
	...
	/**
	 * Methode setzt die auszuführende Aktion, bei Änderung der Auswahl in <code>weightBox</code>.
	 * 
	 * Werte im Table werden temporär übernommen und die zum gewählten Verteilungsgewicht
	 * gehörigen Daten in einem neuen Table dargestellt. 
	 */
	...
	/**
	 * Setzt den Inhalt der <code>weigthBox</code>.
	 * 
	 * Die für den in der <code>edgeBox</code> gewählten Kantentyp definierten Verteilungsgewichte
