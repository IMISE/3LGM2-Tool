...
public final class DynamicTree extends JTree implements MouseListener, ActionListener, GraphDocumentListener, TreeSelectionListener, UserFieldListener, GraphDocumentOwner{
	 ...
	 */
	private LGMTreeNode[] nodesToClear = new LGMTreeNode[ModelConstants.TREE_DOMAIN_LAYER_NODES.length +
												 ModelConstants.TREE_LOGICAL_LAYER_NODES.length +
												 ModelConstants.TREE_PHYSICAL_LAYER_NODES.length];
	 ...
	 * @param d
	 */
	public DynamicTree(GraphDocument d) {
	...
	/**
	 * Setzt das übergebene {@link GraphDocument} für diesen Baum und fügt den Baum als {@link GraphDocumentListener}
	 * hinzu. Beim vorherigen {@link GraphDocument} des Baumes wird der Baum als Listener entfernt. 
	 * 
	 * @param doc
	 */
	public void setGraphDocument(GraphDocument doc) {
		if (this.doc != null) {
	 ...
	 * @param layer
	 */
	public void addObject(ElementContainer ec, boolean performingRebuild, GraphDocument selDoc, int layer) {
...
//			}
	 ...
	 * @param selDoc
	 */
	private void addChildren(LGMTreeNode elementNode, boolean performingRebuild, GraphDocument selDoc) {
	...
	private class HyperlinkString {
		...
		public HyperlinkString(String name, String value) {
			this.name = name;
			this.value = value;
		}
		@Override
	 ...
	 * @param selDoc
	 */
	private void addUserDefinedProperties(LGMTreeNode elementNode, boolean performingRebuild, GraphDocument selDoc) {
	 ...
	 * @param objekt
	 */
	public void removeObject(ElementContainer objekt) {
	 ...
	 * @return
	 */
	public static LGMTreeNode getParentNodeOf(NodeContainer obj) {
		if (obj == null)
			return null;
	 ...
	 * @return
	 */
	protected LGMTreeNode getParentNodeOfType(NodeContainer obj, int layer) {
	 ...
	 * @return
	 */
	protected LGMTreeNode createAndGetUserDefParentNodeOfType(NodeContainer obj) {
	 ...
	 * @param layer
	 */
	public void changeActiveLayer(int layer) {
		changingLayer = true;
		switch (layer) {
			case 4 :
	 ...
	 * @return
	 */
	private final JPopupMenu showNewInstanceContextMenu(String str, int x, int y) {
	 ...
	 * @return
	 */
	public static final int getLayerOf(Knoten knot) {
...
//	TreeSelectionListener 
	...
	/* (non-Javadoc)
	 * @see tool3lgm.graphtools.userfield.event.UserFieldListener#userFieldAdded()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see tool3lgm.graphtools.userfield.event.UserFieldListener#userFieldRemoved()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see tool3lgm.graphtools.userfield.event.UserFieldListener#userFieldValueChanged()
	 */
	@Override
