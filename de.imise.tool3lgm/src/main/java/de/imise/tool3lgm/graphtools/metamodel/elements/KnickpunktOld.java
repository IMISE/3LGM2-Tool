...
import de.imise.tool3lgm.graphtools.view.container.BendpointContainerOld;
 ...
 */
public class KnickpunktOld extends Node {
     ...
     */
    public final BendpointContainerOld getBendpointContainer() {
        return (BendpointContainerOld) getContainer(getGraphDocument());
    }
