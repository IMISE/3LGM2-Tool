...
public class CostingUtil {
	...
	/**
	 * Eine Stringkonstante, die Kennzeichent, dass es sich um einen UserFieldHash handelt.
	 * Sämtliche UserFieldHashes werden während der Prüfung auf sytaktische Korrekthet einer Formel gegen diese Konstante ersetzt.
	 */
	private static final String USERFIELDHASH = "ufh";
	
	/**
	 * Hier sind verschiedene Methoden enthalten, 
	 * die an unterschiedlichen Stellen genutzt werden. 
	 */
	public CostingUtil() {
	}
	 ...
	 * 
	 * @param hash_formula
	 *            FormelString in hash-Form.
	 * @param definitions
	 * @return Den FormelString in menschenlesbarer Form
	 */
	public static final String getHumanReadableFormulaString(String hash_formula, UserFieldDefinitions definitions) {
	...
	/**
	 * Prüft die übergebene Formel auf Korrektheit.
	 ...
	 * @param formula
	 * 	Der zu prüfende Formelstring
	 * @return
	 * 	Gibt true zurück, wenn die übergebene Formel korrekt ist, ansonsten false 
	 */
	public static final boolean isFormulaValid(String formula){
		if(formula==null)
			return false;
		if(formula.equals(""))
			return true;
	 ...
	 */
	public final static String getDisplayableStyleName(UserField.Style style){
	...
	/**
	 * Konvertiert einen FormelString in einen Stack.
	 * Der String wird dazu mittel StringTokenizers zerlegt. Argumente, die ein userField 
	 * kennzeichenen oder +,*,-,/ werden auf den Stack draufgelegt. Verrechnungsfunktionen 
	 * werden als String zusammengefasst und als einzelnes zusammengehörendes Argument auf 
	 * den Stack gelegt.
	 * @param internalFormula 
	 * 		Die Formel in interner repräsentation Bsp: UserFieldHash_XXX_X + ( UserFieldHash_XXX_X )
	 * @return
	 * 		Stack, der die Formel enthält.
	 */
	public static final Stack<String> getStackForInternalFormula(String internalFormula) {
