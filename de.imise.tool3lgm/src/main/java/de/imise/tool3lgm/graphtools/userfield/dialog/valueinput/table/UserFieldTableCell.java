...
interface UserFieldTableCell extends TableCellEditor,TableCellRenderer {
	...
	/**
	 * Zeichen, dass im Editor als Dezimal-Trennzeichnen angezeigt wird.
	 * Sorgt dafür, dass <code>Strings</code> korrekt auf <code>Number</code> geparsed 
	 * werden können.
	 */
	...
	Border ANCHOR_BORDER = BorderFactory.createCompoundBorder(
