...
public class OperatorInputPanel extends JPanel implements ActionListener {
	...
	/**
	 * Ist die <code>ComboBox</code>, die die UserField der Endklasse
	 * anzeigt.
	 */
	 ...
	 * <code>UserField.TWSUM</code>. Legt die Art der verrechnungsfunktion
	 * fest.
	 */
	 ...
	 * @param vfOperator
	 *            Eine der beiden Konstanten <code>UserField.SUM</code> oder
	 *            <code>UserField.TWSUM</code>
	 * @param classElement
	 *            Elementklasse, die sich über die Verrechnungsfunktion
	 *            irgendeinen Wert einer verbundenen Klasse holen soll
	 * @param userField
	 */
	public OperatorInputPanel(String vfOperator, UserField userField) {
		super();
	...
	/**
	 * Aktualisiert die {@link AlphabeticalJList}, die die
	 * {@link UserField}s der assoziierten Klasse enthält.
	 * 
	 * @param elementClasses
	 */
	private final void updateFieldListAttributesOfAssociatedClass(Class<? extends ModelElement> elementClass) {
...
//TODO: das hier sollte eine eigen Funktion der UserFieldDefinitions werden
	 ...
	 * 
	 * @param edgeClass
	 *            die aktuelle Kantenklasse
	 */
	private void updateVGComboBoxItems(Class<? extends ModelElement> edgeClass) {
