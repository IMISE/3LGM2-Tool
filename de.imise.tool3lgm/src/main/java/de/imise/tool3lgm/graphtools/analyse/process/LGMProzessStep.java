...
public class LGMProzessStep {
	 ...
	 */
	private Aufgabe startAufgabe;
	/**
	 * Aufgabe, die in desem Schritt <code>objektTyp</code> interpretiert
	 */
	private Aufgabe endAufgabe;
	/**
	 * Objekttyp, der von <code>startAufgabe</code> bearbeitet und von <code>endAufgabe</code> interpretiert wird
	 */
	...
	/**
	 * die Positionen geben an, wo die startAufgabe und die endAufgabe im Prozess stehen 
	 * (die selben Aufgaben können mehrfach im Prozess vorkommen)
	 */
	 ...
	 */
	private Prozess parentProzess;
//----------------------------------------------------------------------------------------------------------------------------------
	/**
	 * 
	 */
	public LGMProzessStep(	ModelElement parentProzess,
							ModelElement startAufgabe, 
							ModelElement endAufgabe, 
							ModelElement objektTyp, 
							ABKonfiguration startAufgabeKonf, 
							ABKonfiguration endAufgabeKonf,
							int startPosition,
							int endPosition) {
		super();
	 ...
	 * 
	 */
	public LGMProzessStep clone(Object o){
...
//TODO:AXS:prüfen, warum bei diesen komischen clones die Konfigs doppelt gesetzt werden und warum nicht gleich im Konstruktor		
	 ...
	 * 
	 */
	public static LGMProzessStep cloneAndSetKonfigs(Object step, Object startKonfig, Object endKonfig){
...
//----------------------------------------------------------------------------------------------------------------------------------
	/**
	 * @return 
	 * 		<code>true</code>, wenn dieser Step eine gültige Start-Konfiguration mit 
	 * 		einem Anwendungssystem besitzt
	 */
	...
	/**
	 * @return 
	 * 		<code>true</code>, wenn dieser Step eine gültige End-Konfiguration mit 
	 * 		einem Anwendungssystem besitzt
	 */
	...
	//hasStartAufgabe() und hasObjekttyp() sollten, wenn alles wie gedacht funktioniert, immer dasselbe liefern
	//d.h. es ex. eine Startaufgabe gdw. ein Objekttyp ex.
	
	/**
	 * Prüft, ob für den Step eine gültige Start-Aufgabe besitzt
	 * @return
	 * 		<code>true</code>, wenn der Step eine gültige Start-Aufgabe besitzt sonst <code>false</code>
	 */
	 ...
	 * @return
	 * 		<code>true</code>, wenn der Step eine gültige End-Aufgabe besitzt sonst <code>false</code>
	 */
	 ...
	 * 
	 * @return
	 * 		<code>true</code>, wenn alle Variablen nicht <code>null</code> sind.
	 */
...
//----------------------------------------------------------------------------------------------------------------------------------
	 ...
	 * @param list
	 */
	public void setKommProzessKanten(List<Kante> list) {
	 ...
	 * @param list
	 */
	public void setKommProzessSchnittstellen(List<ModelElement> list) {
	 ...
	 * @param konf
	 */
	private void setStartAufgabeKonf(ModelElement konf) {
		startAufgabeKonf = (ABKonfiguration) konf;
	}
	/**
	 * @param konf
	 */
	private void setEndAufgabeKonf(ModelElement konf) {
	 ...
	 * @param list
	 */
	public void setRealCommunicationEndKonf(List<ModelElement> list) {
	 ...
	 * @param list
	 */
	public void setRealCommunicationStartKonf(List<ModelElement> list) {
	 ...
	 * @param i
	 */
	public void setKommProzessLength(int i) {
		kommProzessLength = i;
	}
     ...
     * @param i
     */
    public void setMediumBreaks(int i) {
        mediumBreaks = i;           
    }
}
