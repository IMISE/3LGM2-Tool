...
public class ColPanel extends JPanel {
	 ...
	 */
	public ColPanel(ArrayList<ModelElement> _cols){
		super();
		cols = _cols;
	}
	...
	public void paintComponent(Graphics g) {
		...
		g2.drawLine(1,this.getHeight()-1,getNumberOfCols()*getColWidth(),this.getHeight()-1);
	...
	/**
	 * bestimmt die  benötigten Parameter delta und max_height und legt die
	 * Größe der Component fest
	 * @param g Graphics
	 */
	 ...
	 * @param cols
	 */
	public void setCols(ArrayList<ModelElement> cols){
		this.cols = cols;
		initialized = false;
	}
