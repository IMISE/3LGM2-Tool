...
public class Mapping {
	 ...
	 * @param map
	 */
	public final void adapt(Mapping map) {
	 ...
	 * Layout übder die Funktion <code>getElementClassSpecificLayout(Class)</code>
	 * holen.
	 * 
	 ...
	 */
	private GraphElementLayout getStandardElementLayout(ModelElement me) {
	 ...
	 * @return StandardLayout für Elemente der übergebenen Art
	 */
	public GraphElementLayout getStandardElementLayout(Class<? extends ModelElement> elementClass) {
	 ...
	 * @return 
	 */
	private GraphElementLayout getElementClassSpecificLayout(Class<? extends ModelElement> elementClass){
	 ...
	 * @return
	 */
	public final Color getStandardBackGroundColor(ModelElement me) {
	 ...
	 * @param color
	 */
	public final void setStandardBackGroundColor(Class<? extends ModelElement> elementClass, Color color) {
	 ...
	 * @return
	 */
	public final Dimension getStandardSize(Class<? extends ModelElement> elementClass) {
	 ...
	 * @return
	 */
	public final int getStandardWidth(Class<? extends ModelElement> elementClass) {
	 ...
	 * @param width
	 */
	public final void setStandardWidth(Class<? extends ModelElement> elementClass, int width){
	 ...
	 * @return
	 */
	public final int getStandardHeight(Class<? extends ModelElement> elementClass) {
	 ...
	 * @param height
	 */
	public final void setStandardHeight(Class<? extends ModelElement> elementClass, int height){
	 ...
	 * @param height
	 */
	public final void setStandardSize(Class<? extends ModelElement> elementClass, int width, int height){
	 ...
	 * @return
	 */
	public final GraphElementLayout.SHAPE getStandardForm(ModelElement me) {	
	 ...
	 * @param form
	 */
	public final void setStandardForm(Class<? extends ModelElement> elementClass, GraphElementLayout.SHAPE form) {
	 ...
	 * @return
	 */
	public final Font getStandardFont(ModelElement me) {
	 ...
	 * @param font
	 */
	public final void setStandardFont(Class<? extends ModelElement> elementClass, Font font) {
