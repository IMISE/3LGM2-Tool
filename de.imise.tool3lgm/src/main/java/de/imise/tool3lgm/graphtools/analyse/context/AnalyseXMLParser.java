...
public class AnalyseXMLParser extends DefaultHandler {
	...
	private List<ElementContainer> result;
	 ...
	 * @return
	 */
	public List<ElementContainer> process(Reader input, GraphDocument _doc) {
	 ...
	 * 
	 */
	public static List<ElementContainer> analyze(String str, GraphDocument _doc) {
