...
public class AdditionalLabelTextGenerator {
	...
	/**
	 * Liste der {@link ElementContainer}, an die dieses Objekt etwas ranschreibt
	 * /
	protected HashSet<ElementContainer> specialInfoTargets = null;
	...
	/**
	 * Falls ein anderes Objekt dieses Objekt nur als Stellvertreter nutzen will, kann man hier den
	 * echten Owner verpacken. 
	 */
	 ...
	 * @param layout
	 */
	public AdditionalLabelTextGenerator(GraphElementLayout layout) {
		this(null, layout);
	}
	 ...
	 * @param layout
	 */
	public AdditionalLabelTextGenerator(Object realOwner, GraphElementLayout layout) {
		super();
	 ...
	 * 
	 * /
	private static final void removeAllAdditionalTextFromAllTargets(){
		for (ElementContainer ec : additionalTextTargets)
	 ...
	 * @param i
	 */
	public void setSpecialInfoPosition(int specialInfoPosition) {
	 ...
	 * @param layout
	 */
	public void writeNumberListToTargets(List<ModelElement> specialInfoTargets, GraphDocument doc) {
	 ...
	 */
	private void writeNumberListToTargets(List<ModelElement> specialInfoTargets, GraphDocument doc, int specialInfoPosition) {
