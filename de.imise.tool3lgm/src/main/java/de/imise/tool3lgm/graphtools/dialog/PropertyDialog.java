...
public class PropertyDialog extends JDialog implements WindowListener{
	 ...
	 */
	public PropertyDialog(GDCollection gdcoll) {
	 ...
	 */
	public PropertyDialog(Frame owner, GDCollection gdcoll) {
		super(owner, "", false);
		init(gdcoll);
	}
	 ...
	 * @param graphDocument Document in dessen Kontext der Dialog steht
	 */
	public PropertyDialog(Dialog owner, GDCollection gdcoll) {
		super(owner, "", false);
		init(gdcoll);
	}
	 ...
	 * @param gdcoll
	 */
	private void init(GDCollection gdcoll){
		this.gdcoll = gdcoll;
	 ...
	 * übergebene Klasse mit der Klasse der Componente in dem Tab zuweisungskompatibel ist.
	 * Die Klasse der im Tabpanel enthaltenen Componente muss die gleiche oder eine Unterklasse 
	 * der übergebenen Klasse sein. 
	 * 
	 * @param title
	 * 		Titel des zu selektierenden Tabs
	 * @param tabComponentClass
	 * 		Oberklasse der Komponente in dem zu selektierenden Tab
	 * @return
	 * 		<code>true</code>, wenn ein Tab der angegebenen Art gefunden und in den Vordergund geracht
	 * 		werden konnte
	 */
	public boolean selectTab(String title, Class<? extends Component> tabComponentClass){
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	// WindowListener -> bei Aktivierung im Contextgenerator auf das GraphDocument des Dialoges wechseln //
	///////////////////////////////////////////////////////////////////////////////////////////////////////
