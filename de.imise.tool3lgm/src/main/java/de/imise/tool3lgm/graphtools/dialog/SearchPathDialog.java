 ...
 *
 *	TODO:AXS: Verallgemeinern und ab ins utils-package (also von allen tool3lgm-Zeug auﬂerhalb des util-Packages befreien)
 *
...
public class SearchPathDialog extends JDialog implements ActionListener{
	...
	private JCheckBox includeSubDir = new JCheckBox(Tool3lgmConstants.getResString("trans_subdir"));

	private DirectoryTreePane pathTree;

	public SearchPathDialog(JFrame owner, List<File> importPath) {
		super(owner, Tool3lgmConstants.getResString("trans_path"), true);
		init(importPath);
	}

	public SearchPathDialog(JDialog owner, List<File> importPath) {
		super(owner, Tool3lgmConstants.getResString("trans_path"), true);
		init(importPath);
	}

	private void init(List<File> importPath) {
		setSize(400, 400);
	...
	public void actionPerformed(ActionEvent e) {
		...
		private List<File> rekAddSubDir(Object[] path) {
