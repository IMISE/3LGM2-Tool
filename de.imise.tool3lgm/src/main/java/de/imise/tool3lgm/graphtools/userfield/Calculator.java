...
public class Calculator {
	 ...
	 *  
	 */
	public Calculator(UserFieldDefinitions definitions) {
		super();
	 ...
	 * was noch erhebliches Optimierungspotenzial in sich birgt ;)
	 * 
	 * dazu wird der übergebene String zuerst in mittels Stringtokenizers
	 * zerlegt und in einen Stack kopiert. Es wird eine spiegelverkerhrte Kopie
	 * des Stacks angelegt, die nicht mehr die Referenzen auf die Werte in Form
	 * von <code>UserField</code> s enthält sonderen die konkreten Werte! Der
	 * Stack ist spiegelverkerhrt damit auch korrekt gerechnet werden kann.
	 * 
	 * Zum Rechnen wird ein weiterer Hilfs-Stack initialisiert, der solange
	 ...
	 * Das Ergebnis wird wieder auf den Hautstack gelegt. 
	 * 
	 * Das geschieht iterativ so lange, bis der HautptStack keine Operatoren mehr beinhaltet.
	 * 
	 * @param userField :
	 *            das zu berechnende UserField
	 * @param data.me :
	 *            Das konkrete ModelElement, für das die KF ausgewertet wird.
	 * @return Das Ergebnis als String
	 */

	public String calculate(UserField userField, UserFieldTarget userFieldTarget) {
...
//		in TWSUM auch SUM steckt)
	 ...
	 * 
	 * @param infix
	 * 	Der StringBuilder, dessen Formelwerte ersetzt werden müssen
	 * @param userField
	 * 	Das <code>userField</code>, dessen Wert geholt werden soll.
	 * @param me
	 * 	Das ModelElement, für das der <code>userField</code>-Wert geholt werden soll.
	 * @param accountingFunction
	 * 	Der String der Verrechnungsfunktion, für die die Formeln durch ihre Werte ersetzt werden sollen.
	 * @return Gibt bei erfolgreichem Ersetzen nichts zurück. im FehlerFall wird der entsprechende Errorstring zurückgegeben.
	 */
	private String replaceInfixString(StringBuilder infix, UserField userField, ModelElement me, String accountingFunction){
		...
		while (startIndexOfFunction >= 0) {
			...
			//jetzt berechnen der TeilwertSumme anstoßen
				...
				if(accountingFunction.equals(UserField.ACCOUNTING_FUNCTION_MAX))
					//jetzt Suchen des Maximums anstoßen
					value = getMAX(userField, me, arguments);
			else
				if(accountingFunction.equals(UserField.ACCOUNTING_FUNCTION_REF))
					//jetzt das Heraussuchen dees Referenzierten wertes anstoßen.
					value = getREF(userField, me, arguments);
			else
				if(accountingFunction.equals(UserField.ACCOUNTING_FUNCTION_AVG))
	 ...
	 * denen ein Operand <code>UserField.NO_ELEMENTS_CONNECTED</code> ist,
	 * wird nur der jeweils andere Operand zurückgegeben. Bei Subtraktionen, bei
	 ...
	 * erste Operand <code>UserField.NO_ELEMENTS_CONNECTED</code>, dann wird
	 * der zweite Operand mal -1 zurück gegeben.
	 * 
	 * Wenn in einer Atom-Formel kein Fehler enthalten ist, wird die Berechnung
	 * durchgeführt und das Ergebnis zurückgeliefert.
	 * 
	 * 
	 * Spezielle Rechenregeln bei der Division. NOC =
	 * <code>UserField.NO_ELEMENTS_CONNECTED</code>, ES =
	 * UserField.EMPTY_STRING, 7 = beliebige Zahl
	 * 
	 * NOC / NOC = return NOC NOC / ES = return NOC NOC / 7 = return NOC ES /
	 * NOC = return NOC ES / ES = return ES ES / 7 = return ES 7 / NOC = return
	 * NOC 7 / ES = return ES 7 / 7 = rechne einfach damit
	 * 
	 * @param operand1
	 *            Der erste Operand der Atom-Formel
	 * @param operand2
	 *            Der zweite Operand der Atom-Formel
	 * @param operator
	 *            Der Operator der Atom-Formel
	 ...
	 *  
	 */
	private static final String getResult(String operand1, String operand2, String operator) {
...
//		System.err.println("\""+operand1+"\"\t" + "\""+operator+"\"\t\""+operand2+"\"");
	...
	/**
	 * Errechnet das Ergebnis der Verrechnungsfunktion TEILWERTSUMME.
	 * 
	 * Die Funktion hat 2, 3 oder 4 Argumente. Das erste Argument ist in jedem
	 * Fall der Name der Assoziation über den verrechnet wird, das 2. ist immer
	 * das <code>UserField</code> der verbundenen Klasse, dessen Wert
	 * verrechnet werden soll.
	 * 
	 * Bei 3 Argumenten kann das 3. Argument entweder ein Verteilungsgewicht
	 * sein oder, wenn die Kante über die verrechent wird eine
	 * <code>PartOfBeziehung</code> ist, die Richtung der Verrechnung.
	 * 
	 * Bei 4 Argumenten ist das 3. Argument immer das Verteilungsgewicht und das
	 * 4 immer die Richtung.
	 * 
	 ...
	 * @return
	 */
	private String getTWSUM(UserField resultUserField, ModelElement me, String twsumFormula) {
	 ...
	 * 
	 * @param resultUserField
	 *            das konkrete <code>UserField</code>, auf dessen Wert
	 *            referenziert wird.
	 * @param me
	 *            Für diese Kante ist die Kennzahlformel definiert. Dieses
	 *            <code>UserField</code> zeigt auf ein UserField welches an
	 *            einer Elementklasse
	 * @param refFormula
	 * @return
	 */
	private String getREF(UserField resultUserField, ModelElement me, String refFormula) {
//TODO:AXS:prüfen, ob hier Klassenvergleiche auf Zuwesiungskompatibilität oder auf Identität zielen sollten
	 ...
	 * @return
	 */
	private static final ArrayList<Kante> getEdges(ModelElement me, Class<?> elemClass, Class<?> edgeClass, String direction){
...
//			if (me!=null && elemClass!=null && edgeClass!=null)
	...
	/**
	 * Errechnet das Ergebnis der Verrechungsfunktion SUM oder TWSUM. Die Funktion geht
	 * davon aus, dass alle übergebenen Parameter korrekt sind.
	 * 
	 * @param resultUserField
	 * @param me
	 *            das konkrete <code>ModelElement</code>, für das die
	 *            Verrechnungsfunktion aufgelöst werden soll.
	 * @param formula
	 *            Die Formel (in INFIX-Notation)
	 * @return Ergebnis der Verrechungsfunktion SUM
	 */
	private String getResultOfVF(UserField resultUserField, ModelElement me, String formula, String accountingFunction) {
	 ...
	 * @return Ergebnis der Verrechungsfunktion SUM
	 */
	private String getSUM(UserField resultUserField, ModelElement me, String formula, String accountingFunction) {
	 ...
	 */
	private String getMULT(UserField resultUserField, ModelElement me, String formula, String accountingFunction) {
		return getResultOfVF(resultUserField, me, formula, accountingFunction);
	}
	 ...
	 * 	Den kleinsten Wert.
	 */
	private String getMIN(UserField resultUserField, ModelElement me, String minFormula) {
	 ...
	 * 	Den größten Wert.
	 */
	private String getMAX(UserField resultUserField, ModelElement me, String maxFormula) {
		return getMINMAX(resultUserField, me, maxFormula, UserField.ACCOUNTING_FUNCTION_MAX);

	}

	/**
	 * Errechnet das Ergebnis der Verrechungsfunktion MIN bzw MAX. Die Funktion geht
	 * davon aus, dass alle übergebenen Parameter korrekt sind.
	 * 
	 * @param resultUserField
	 * @param me
	 ...
	 *            Die Formel (in INFIX-Notation)
	 * @return 
	 * 	Ergebnis der Verrechungsfunktion MIN bzw MAX
	 */
	private String getMINMAX(UserField resultUserField, ModelElement me, String minMaxFormula, String accountingFunction) {
		//	ArrayList elements = gd.getAllModelElements(me.getClass(), true);
	 ...
	 */
	private String getAvg(UserField resultUserField, ModelElement me, String avgFormula) {
	 ...
	 * 
	 * @param indicatorFormulaString
	 *            Formel einer Kennzahl der eine Indikatorfunktion beschreibt
	 * @param target
	 * @return gibt den Indikatorwert zurück.
	 */
	private String getIndi(UserFieldTarget target, String indicatorFormula) {
	 ...
	 */
	private String getValueOfReferencedUserField(String userFieldHash, UserFieldTarget target) {
	...
	public void setUserFieldDefinitions(UserFieldDefinitions definitions){
		this.definitions=definitions;
	}
