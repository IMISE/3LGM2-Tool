...
public class MetaModelInstance {
    ...
    // * Bedeutung haben.
    // */
    // private final Map<Class<? extends ModelElement>, Set<Class<? extends Edge>>> elementClassToSortedEdges =
    // metaModel.getElementClassToSortedEdges();
    //
    ...
    // */
    // private Set<Class<? extends ModelElement>> onlyExpertModeEditableNodes;
    //
    // /** Alle Elementklassen, die ein Layout brauchen, weil die selbst oder an anderen Elementen in der Grafik dargstellt werden */
    // private Set<Class<? extends ModelElement>> elementClassesWithLayout;
    //
    // /**
    ...
    // allNodesSet = ImmutableSet.<Class<? extends ModelElement>>
    // builder().addAll(allDomainLayerNodesSet).addAll(allInterDomainLogicalLayerNodesSet).addAll(allLogicalLayerNodesSet).addAll(allInterLogicalPhysicalLayerNodesSet)
    ...
    //
    // /**
    // * Berechnet aus den vorher initialiserten allNodesSet und allEdgesSet ein Set, das alle Elementklassen inklusive aller abstracten Oberklassen
    // bis
    ...
    //
    // /**
    // * Berechnet aus den vorher initialiserten allNodesSet und der GraphViewDefinition ein Set, das alle Elementklassen enthält, die ein Layout
    // * brauchen.
    // *
    // * @return
    // */
    ...
    //
    // /**
    // * Berechnet aus den vorher initialiserten allNodesSet und der GraphViewDefinition ein Set, das alle Elementklassen enthält, die Kanten, bei
    // denen
    // * die Reihenfolge relevant ist, zu anderen Elementarten hat, die selbst paintable sind. Wenn das der Fall ist, dann kann an diese anderen
    // * Elemente die Nummer(n) der Kanten geschrieben werden. In welcher Farbe das geschieht, bestimmt das Layout des Ausgangselementes.
    // *
    // * @return
    // */
    // private final Set<Class<? extends ModelElement>> getElementClassesWithSortedEdgeClassesToPaintable() {
    // ImmutableSet.Builder<Class<? extends ModelElement>> elementClassesWithSortedEdgesBuilder = ImmutableSet.<Class<? extends ModelElement>>
    // builder();
    // for (Class<? extends ModelElement> clazz : allNodesSet) {
    ...
    // * @param creatableOnly wenn <code>true</code>, werden von den anzuzeigenden Knoten nur die übrig gelassen, die man auch ohne ein anderes
    // Element
    // * anlegen kann
    // * @return
    // */
    // private Set<Class<? extends ModelElement>> getTreeVisibleNodes(final Iterable<Class<? extends ModelElement>> elementClasses, final boolean
    // creatableOnly) {
    ...
    //
    // /**
    // * Liefert <code>true</code>, wenn die Klasse nicht angezeigt werden soll, also wenn die Option {@link
    // BooleanProperty#OPTION_ENABLE_EXPERT_MODE}
    ...
    // if (InstanciationEdge.class.isAssignableFrom(elementaryMetaPath.getEdgeClass()) &&
    // InstanciationEdge.INSTANCE_TO_TEMPLATE_MASTER_DIRECTION.equals(elementaryMetaPath.getDirection())) {
    // return false;
    // }
    // }
    // }
    ...
    // //return getSortedEdgeClasses(elementClass).contains(edgeClass); //das kommt auf dasselbe raus wie das oben. Ich konnte mich nicht entscheiden,
    // was besser ist -> daher nur auskommentiert
    // }
    //
    // /**
    ...
    // // Sys.err1("isDirectedEdge: edgeClass=" + edgeClass.getSimpleName() + " startClass=" + startClass + " endClass=" + endClass + "
    // isDoubleMeaningEdge=" + isDoubleMeaningEdge + " forwardMetaAssociationName='" + forwardMetaAssociationName
    // // + "' backwardMetaAssociationName='" + backwardMetaAssociationName + "'\n\t-> " + (startClass != endClass) + " || " + isDoubleMeaningEdge + "
    // || " + !forwardMetaAssociationName.equals(backwardMetaAssociationName));
    // // }
    // return Edge.getStartClass(edgeClass) != Edge.getEndClass(edgeClass) || isDoubleMeaningEdge(edgeClass) ||
    // !ElementsNameBuilder.getForwardMetaAssociationName(edgeClass).equals(ElementsNameBuilder.getBackwardMetaAssociationName(edgeClass));
    // }
    //
    // /**
    ...
    // */
    // public static final Multimap<Class<? extends ModelElement>, Class<? extends ModelElement>>
    // ELEMENT_CLASS_TO_NON_ABSTRACT_ASSIGNABLE_ELEMENT_CLASSES = HashMultimap.create();
    //
    // /**
    // * Liefert alle nichtabstrakten, zur übergebenen Klasse zuweisungskompatiblen Element- oder Kantenklassen. Die übergebene Klasse selbst ist in
    // den
    ...
    // * @return
    // */
    // public static final Collection<Class<? extends ModelElement>> getInstanciableAssignableClasses(final Class<? extends ModelElement>
    // elementClass) {
    ...
    // * In der äußeren und allen inneren HashMaps sind immer dieselben Schlüsselelemente enthalten. Für ein Paar von Schlüsselelementklassen ist
    // immer
    // * dasselbe Kanteklassen-Array abgelegt - egal in welcher Reihenfolge man die Elementeklassen als Schlüssel
    // * einsetzt.
    // */
    // private static final HashMap<Class<? extends ModelElement>, HashMap<Class<? extends ModelElement>, Class<? extends Edge>[]>>
    // ELEMENT_CLASS_TO_MAP_FROM_ELEMENT_CLASS_TO_EDGE_CLASSES = new HashMap<>();
    //
    // /**
    ...
    // */
    // @SuppressWarnings("unchecked")
    // public static final Class<? extends Edge>[] getEdgeTypes(final Class<? extends ModelElement> elementClass1, final Class<? extends ModelElement>
    // elementClass2) {
    // HashMap<Class<? extends ModelElement>, Class<? extends Edge>[]> elementClassToEdgeClass =
    // ELEMENT_CLASS_TO_MAP_FROM_ELEMENT_CLASS_TO_EDGE_CLASSES.get(elementClass1);
    ...
    // if (!metaModel.isRemovedEdgeClass(elementClass2, edgeClass)) { // !metaModel.isRemovedEdgeClass(elementClass1, edgeClass) wird schon in
    // getEdgeTypes(elementClass1) geprüft
    ...
    //
    // /** Alle im Baum auf der FE anlegbaren Node */
    // public static final Iterable<Class<? extends ModelElement>> CREATABLE_LOGICAL_LAYER_NODES = getTreeVisibleNodes(TREE_LOGICAL_LAYER_NODES,
    // true);
    //
    // /** Alle im Baum auf der PWE sichtbaren Node */
    // public static final Iterable<Class<? extends ModelElement>> TREE_PHYSICAL_LAYER_NODES = getTreeVisibleNodes(ALL_PHYSICAL_LAYER_NODES_SET,
    // false);
    //
    // /** Alle im Baum auf der PWE anlegbaren Node */
    // public static final Iterable<Class<? extends ModelElement>> CREATABLE_PHYSICAL_LAYER_NODES = getTreeVisibleNodes(TREE_PHYSICAL_LAYER_NODES,
    // true);
    //
    // // static {
    ...
    //
    // /**
    // * Liefert <code>true</code>, wenn die übergebenen Klasse eine Knotenklassen ist, die in jedem Teilmodell vorkommt, also nicht in jedem
    // Teilmodell
    ...
    //
    // /**
    // * Liefert <code>true</code>, wenn die übergebene Kantenklasse selbst Assoziationen zu anderen Elementen haben kann - also eine
    // Assoziationsklasse
    // * ist.
    // *
    // * @param elementClass
    ...
    // private static final Set<Class<? extends ModelElement>> META_MODEL_INDEPENDENT_MODEL_ELEMENT_TYPES = ImmutableSet.of(Bendpoint.class,
    // Textfield.class);
    //
    // /** Klassennamen aller Modellelementklassen, die instanziierbar sind und in jedem Metamodell automatisch enthalten sind */
    // private static final Set<String> META_MODEL_INDEPENDENT_MODEL_ELEMENT_TYPE_NAMES =
    // CollectionUtils.getSimpleClassNames(META_MODEL_INDEPENDENT_MODEL_ELEMENT_TYPES);
    //
    ...
    // * @return
    // */
    // private static final int getEdgeLayer(final Map<Class<? extends ModelElement>, Integer> map, final Class<? extends ModelElement>
    // edgeStartClass, final Class<? extends ModelElement> edgeEndClass) {
    ...
    // * denen mindestens eine Endklasse (bei <code>isMaster==false</code>) oder eine Startklasse (bei <code>isMaster==true</code>)
    ...
    // */
    // @SuppressWarnings("unchecked")
    // private static Class<? extends CompositionEdge>[] getCompositionEdgeTypes(final Class<? extends ModelElement> elementClass, final boolean
    // isMaster) {
    ...
    //
    // /**
    // * Liefert <code>true</code>, wenn die übergebene Elementklasse mindestens einer anderen Klasse untergeordnet ist. Das erkennt man daran, dass
    // die
    ...
    // for (Class<? extends Edge> edgeClass : getEdgeTypes(elementClass)) {
    // //System.err.print(elementClass.getSimpleName() + " ---> " + edgeClass.getSimpleName() + " ---> " + Edge.getMinCardinality(elementClass,
    // edgeClass) + " ---> ");
    ...
    // //wenn das andere, benötigte Element aber mit einer Compostion untergeordnet ist, dann wird dieses benötigte, untergeordnete Element in der
    // GDCollection-Funktion createInitialSubtypes(...) auomatisch erzeugt und somit die Konsistenz automatisch hergestellt und damit gilt dieses
    // Element nicht als anhängig
    ...
    //
    // /**
    // * Liefert alle anlegbaren MetaPfade, bei denen für selektierte Elemente der übergebenen Elementart im Kontextmenü eine Liste aller
    // existierenden
    ...
    // * @param elementClass2
    // */
    // public static Collection<SimpleMetaPath> getCreatableMetaPaths(final Class<? extends ModelElement> elementClass1, final Class<? extends
    // ModelElement> elementClass2) {
