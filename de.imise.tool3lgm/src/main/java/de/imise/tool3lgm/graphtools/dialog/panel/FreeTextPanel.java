...
public class FreeTextPanel extends ElementDialogPanel {
	 ...
	 * COMMENTME
	 */
	private LimitedSizeScrollTextPane nameTextPane, descriptionTextPane;
	 ...
	 * @param p
	 */
	public FreeTextPanel(Class<? extends ModelElement> searchElementClass, ElementPropertyDialog p) {
		super(p);
