...
/**
 * Diese Klasse dient nur dazu Elemente anzulegen und die package-sichtbare
 * Funktion {@link ModelElement#setMetaModel()} aufrufen zu können, was von
 * außerhalt nicht gehen soll. Dieser ganze Umweg ist nur nötig, damit nicht
 * jede Untrklasse von ModelElement einen Konstruktor braucht, in dem das
 * MetaModel übergeben wird.
 *
