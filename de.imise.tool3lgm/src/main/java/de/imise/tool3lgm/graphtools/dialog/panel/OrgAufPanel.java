...
/**
 * Mit diesem Panel zeigen Organisationseinheiten ihre Aufgaben an.
 * 
 * Dieses Panel ist momentan überflüssig. Es wurde durch das <code>AufOrgPanel</code>
 * ersetzt, welches auch gleich die Gegenrichtung darstellen kann und so auch das
 * <code>AufOrgPanel</code> ersetzt.
 */
public class OrgAufPanel extends ElementDialogPanel {
	...
	public OrgAufPanel(ElementPropertyDialog dl) {
		super(dl);
