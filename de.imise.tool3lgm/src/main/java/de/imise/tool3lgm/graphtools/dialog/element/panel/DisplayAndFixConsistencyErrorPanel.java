...
/**
 * Should be implemented by all panels that display errors or where errors can
 * be fixed.
 *
...
public interface DisplayAndFixConsistencyErrorPanel {
    ...
    /**
     * This panel should return either itself or a sub-panel of itself that
     * displays the MetaPath of the error for the ModelElement of the
     * consistency error - i.e. the panel where the error could be fixed. If it
     * is not this panel or subpanel itself, then <code>null</code> is returned.
     *
