...
public class OverwriteDialog extends JDialog implements ActionListener {
	...
	private OverwriteDialog(Frame owner, ModelElement me1, ModelElement me2) throws HeadlessException {
		super(owner);
		...
		this.getContentPane().add(new JLabel(Tool3lgmConstants.getResString("overwriteDialog_text")), BorderLayout.NORTH);
		...
		String text = (me1 instanceof Kante ? 
	 ...
	 * @return
	 */
	public static int showDialog(Frame owner, ModelElement old, ModelElement insert) {
