...
//	private STYLE style = STYLE.tab;
	private STYLE style = STYLE.combobox;
	 ...
	 * @return
	 */
	public final void addCollection(GDCollection gdcoll) {
	 ...
	 * @param gdcoll
	 */
	public void updateTitle(GDCollection gdcoll) {
	 ...
	 * @return
	 */
	private ModelBrowser getModelBrowser(GDCollection gdcoll) {
		if (showModelsInSeparateBrowser){
