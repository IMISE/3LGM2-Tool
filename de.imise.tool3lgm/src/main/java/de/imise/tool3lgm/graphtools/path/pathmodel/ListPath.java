...
public abstract class ListPath extends AbstractPath implements Iterable<AbstractPath> {
     ...
     * @param paths
     */
    public ListPath(final AbstractMetaPath metaPath, final ModelElement startElement, final ModelElement endElement, final AbstractPath[] paths) {
     ...
     * @param paths
     */
    public ListPath(final AbstractMetaPath metaPath, final ModelElement startElement, final ModelElement endElement, final List<AbstractPath> paths) {
        super(metaPath, startElement, endElement);
