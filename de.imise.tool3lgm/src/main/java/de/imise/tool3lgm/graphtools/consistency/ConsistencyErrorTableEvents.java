...
public class ConsistencyErrorTableEvents extends MouseAdapter {
	...
	private ArrayList<ModelElement> selectedErrorElements = new ArrayList<ModelElement>();
	
	
	/**
	 * 
	 */
	ConsistencyErrorTableEvents(ConsistencyChecker checker, JTable errorTable) {
		super();
		this.checker = checker;
		this.table = errorTable;
	}
...
/*		JMenuItem item = new JMenuItem(new AbstractAction(Tool3lgmConstants.getResString("error_element_properties")){
			@Override
