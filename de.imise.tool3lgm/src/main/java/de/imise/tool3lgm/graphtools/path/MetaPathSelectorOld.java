...
public class MetaPathSelectorOld implements ActionListener {
     ...
     * Bei <code>false</code> werden nur die Mtepfade zurück gegeben, die für die Startklasse selbst und ihre Oberklassen definiert wurden.
     */
    private boolean subClassPathsForSuperClasses = false;
     ...
     *            wurden.
     */
    public MetaPathSelectorOld(final MetaPathDefinition model, final int maxParallelSelectedPaths, final boolean subClassPathsForSuperClasses) {
        super();
        elementClassesWithPaths = model.getStartElementClassesWithPaths(true, subClassPathsForSuperClasses);
        this.model = model;
        this.maxParallelSelectedPaths = maxParallelSelectedPaths;
        this.subClassPathsForSuperClasses = subClassPathsForSuperClasses;
     ...
     */
    public static final MetaPathSelectorOld showDialog(final MetaPathDefinition model, final int maxParallelSelectedPaths) {
     ...
     *         Dialog gefüllt wurde
     */
    public static final MetaPathSelectorOld showDialog(final MetaPathDefinition model, final String class1Label, final String class2Label, final String metaPathListLabel, final int maxParallelSelectedPaths) {
        if (dialogMetaPathSelecor == null) {
            dialogMetaPathSelecor = new MetaPathSelectorOld(model, maxParallelSelectedPaths, false);
        }
