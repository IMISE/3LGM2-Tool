 ...
 * Datenverarbeitungsbausteinkonfigurationen verbundenen physische Datenverarbeitungsbausteine an.
...
public class PDVBKonfPanel extends LGMDragNDropPanel {
    ...
    private final DefaultTreeModel model, pdvbmodel;
    private final LGMTreeNode root, pdvbroot;
    ...
    public PDVBKonfPanel(final ElementPropertyDialog pd) {
        super(pd);
