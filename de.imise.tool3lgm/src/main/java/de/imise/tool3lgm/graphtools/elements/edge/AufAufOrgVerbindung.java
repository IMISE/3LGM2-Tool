...
//	private static Object[][] etcl = {{AufOrgKombination.class, ModelConstants.ZERO, ModelConstants.UNLIMITED}}; 
	 ...
	 * @param knot2
	 */
	public AufAufOrgVerbindung(ModelElement knot1, ModelElement knot2) {
		super(knot1, knot2);
	}
	 ...
	 */
	public AufAufOrgVerbindung(ModelElement knot1, ModelElement knot2, boolean registerInKnots) {
