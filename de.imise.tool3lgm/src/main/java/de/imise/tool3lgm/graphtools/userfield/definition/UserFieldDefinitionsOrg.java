 ...
 */
public final class UserFieldDefinitionsOrg extends UserFieldDefinitionChangeHandler implements Cloneable {

    public UserFieldDefinitionsOrg(final GDCollection gdcoll) {
        super(gdcoll);
    }
    ...
    //
    //    /**
    //     * Analyzer, über den der Zustand dieser {@link UserFieldDefinitionsOrg}
    ...
    //     *         {@link UserFieldDefinitionsOrg} abgefragt werden kann
    //     */
    ...
    //
    //    @Override
    //    public UserFieldDefinitionsOrg clone() {
    //        UserFieldDefinitionsOrg def = null;
    //        try {
    //            def = (UserFieldDefinitionsOrg) super.clone();
    ...
    //     * @param otherDef
    //     */
    //    public void addAll(final UserFieldDefinitionsOrg otherDef) {
