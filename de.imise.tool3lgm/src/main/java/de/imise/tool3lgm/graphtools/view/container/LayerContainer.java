...
//	private String additionalTextAbove, additionalTextDown;
	 ...
	 * @param map
	 */
	public LayerContainer(ModelElement neu, GraphDocument gd, int layerNumber) {
		super(neu, gd);
	 ...
	 * @param map
	 */
	public LayerContainer(ElementContainer alt, GraphDocument gd, int layerNumber) {
		super(alt, gd);
		this.layerNumber = layerNumber;
		layout = new GraphElementLayout();
		init();
	 ...
	 * @param map
	 */
	public LayerContainer(ModelElement neu, GraphElementLayout l, GraphDocument gd, int layerNumber) {
		super(neu, l, gd);
		this.layerNumber = layerNumber;
		layout = new GraphElementLayout();
		init();
	 ...
	 * @return
	 */
	public int countType(Class<? extends ModelElement> elementClass) {
		int counter = 0;
	 ...
	 * @param ec
	 */
	public void z_move_down(ElementContainer ec) {
	 ...
	 * @param ec
	 */
	public void z_move_up(ElementContainer ec) {
		boolean visible = ec.isVisible();
		remove(ec);
	 ...
	 * @param position
	 */
	public void z_move(ElementContainer ec, int position){
	 ...
	 * @param ec
	 */
	public void z_step_up(ElementContainer ec) {
	 ...
	 * @param ec
	 */
	public void z_step_down(ElementContainer ec) {
		z_move(ec, indexOf(ec)-1);
	}
	 ...
	 * @param stufe
	 */
	public final void raiseSlaves(ElementContainer ec, int stufe) {
		if (! (ec instanceof NodeContainer))
			return;
...
*/
				...
				float dash[] = {dashWidth, rasterWidth-dashWidth};
...
*/	}
	 ...
	 * @return
	 */
	public String getXMLString(String preString, int _layer, boolean forCopy) {
	 ...
	 * @return
	 */
	public boolean containsHashString(String hashString) {
	 ...
	 * @param kc
	 */
	public void resetPositionOf(NodeContainer kc) {
	 ...
	 * @return
	 */
	public int indexOf(ModelElement me) {
	 ...
	 * @return
	 */
	public int indexOf(ElementContainer ec) {
	 ...
	 * @return
	 */
	public EdgeContainer getEdgeContainer(int i) {
	 ...
	 * @return
	 */
	public EdgeContainer getEdgeContainer(String hashString) {
	 ...
	 * @return
	 */
	public BendpointContainer getBendpointContainer(int i) {
	 ...
	 * @return
	 */
	public boolean isMyElement(ElementContainer ec) {
     ...
     */
    public void setShowAllInterLayerConnections(boolean showInterLayerConnections) {
     ...
     */
    public void setShowInterLayerConnections(boolean showInterLayerConnections, ElementContainer ec) {
	 ...
	 * @param kc
	 */
	public void addTmpEdgeContainer(EdgeContainer kc) {
	 ...
	 * @param string
	 */
	public void setAdditionalTextAbove(Class<? extends ModelElement> elementClass, String string) {
	 ...
	 * @param string
	 */
	public void addAdditionalTextAbove(Class<? extends ModelElement> elementClass, String string) {
		if (additionalTextAbove==null){
			additionalTextAbove = new ElementTypeStringPair();
			additionalTextAbove.set(elementClass, string);
			return;
	 ...
	 * @param elementClass
	 */
	public void removeAdditionalTextAbove(Class<? extends ModelElement> elementClass) {
		if (additionalTextAbove==null)
			return;
	 ...
	 * @param string
	 */
	public void setAdditionalTextDown(Class<? extends ModelElement> elementClass, String string) {
	 ...
	 * @param string
	 */
	public void addAdditionalTextDown(Class<? extends ModelElement> elementClass, String string) {
		if (additionalTextDown==null){
			additionalTextDown = new ElementTypeStringPair();
			additionalTextDown.set(elementClass, string);
			return;
	...
	private class ElementTypeStringPair {
		...
		public void set(Class<?> clazz, String s){
		 ...
		 * @param s
		 */
		public void add(Class<?> clazz, String s){
			for (int i=0; i<elementClassList.size(); i++){
				if (elementClassList.get(i)==clazz){
