...
public class XMLAnalyse extends AbstractAnalyse {
	 ...
	 * @return				wenn kein Fehler beim erzeugen der XMLAnalyse auftrat, wird 
	 * eine neue XMLAnalyse mit den übergebenen Parametern zurück gegeben.
	 * @throws SAXException wenn ein Fehler beim parsen des Analysetextes auftritt.
	 */
	public static XMLAnalyse createAnalyse(String analyseText) throws SAXException {
	 ...
	 * @throws SAXException wenn ein Fehler beim parsen des Analysetextes auftritt.
	 */
	public static XMLAnalyse createAnalyse(String name, String analyseText) throws SAXException {
		XMLAnalyse xMLAnalyse = new XMLAnalyse();
	...
	public void setXMLText(String xmlText) throws SAXException {
		if (xmlText == null || xmlText.trim().length() == 0) 	xmlText = "<analyse>\n\n</analyse>";
	 ...
	 */
	private void addStartknoten(String startknoten) {
	...
	@Override
	public final List<ElementContainer> getResult(GraphDocument doc) {
	 ...
	 * @throws SAXException wenn ein Fehler beim parsen des Analysetextes auftritt.
	 */
	public void parseAnalyse(String analyseText) throws SAXException {		
