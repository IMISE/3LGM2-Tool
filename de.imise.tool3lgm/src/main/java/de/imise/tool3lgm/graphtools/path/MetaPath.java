...
public class MetaPath {
	...
	/**
	 * @param startClass
	 *            ModelElement class where associations starts
	 * @param endClass
	 *            ModelElement class where associations ends
	 * @param associations
	 *            int[][] with type-constants for connections to come from start
	 *            to end (int[] diverent possibilities to come from start to
	 *            end)
	 * @throws InvalidPathException
	 */
    public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>... associations) {
	 ...
	 * @throws InvalidPathException
	 */
	public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>[][] path) {
	 ...
	 *            end)
	 * @param description
	 *            String with description for associations (in legend)
	 * @throws InvalidPathException
	 */
	public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>[][] path, String description) {
	 ...
	 *            String with description for associations (in legend)
	 * @param directional
	 *            boolean with true, if it is important which element is in row
	 *            an which in column (exp: row is part of col; but not for
	 *            function reads objecttype )
	 * @throws InvalidPathException
	 */
	public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>[][] path, String description, boolean directional) {
	 ...
	 *            end)
	 * @param color
	 *            Color for item in legend and cell
	 * @param description
	 *            String with description for associations (in legend)
	 * @throws InvalidPathException
	 */
	public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>[][] path, Color color, String description) {
	 ...
	 *            end)
	 * @param color
	 *            Color[] for items in legend and cell (one color for DOUBLE /
	 *            FORWARD / BACKWARD)
	 * @param description
	 *            String[] with descriptions for associations (in legend) (one
	 *            description for DOUBLE / FORWARD / BACKWARD)
	 * @throws InvalidPathException
	 */
	public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>[][] path, Color[] color, String[] description) {
	 ...
	 *            String[] with descriptions for associations (in legend) (one
	 *            description for DOUBLE / FORWARD / BACKWARD)
	 * @parma int control index of connections in associations, which control
	 ...
	 * @throws InvalidPathException
	 */
	public MetaPath(Class<? extends ModelElement> startClass, Class<? extends ModelElement> endClass, Class<? extends Kante>[][] path, Color[] color, String[] description, int control, boolean directional){
		this.directional = directional;
		this.startClass = startClass;
		this.endClass = endClass;
		this.control = path[0].length - (control + 1);
		this.associations = path;
	...
	/**
	 * Es wird sicher gestellt, dass die Assoziationen einen Pfad von der Start- zur Zielklasse des Pfades beschreiben.
	 * 
	 * Im Moment wird noch nicht die Konsistenz geprüft, sondern nur, ob die erste Assoziation zur Startklasse und die
	 * letzte Assoziation zur Endklasse passen.
	 * 
	 */
	 ...
	 * /
	@SuppressWarnings("unchecked")
    private static final Class<? extends Kante>[][] getPathForAssociation(Class<? extends Kante> edgeClass){
		Class<? extends Kante>[][] associations = new Class[1][1];
		associations[0][0] = edgeClass;
		return associations;
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static final Class<? extends Kante>[][] getPathForAssociations(Class<? extends Kante>... edgeClasses) {
	 ...
	 * 
	 * @param Index
	 *            des Metapfades, dessen Länge zurück gegeben werden soll
	 * @return Länge des Metapfades an Position <code>pathIndex</code>
	 */
	public final int getLength(int pathIndex) {
	...
	/**
	 * Liefert <code>true</code>, wenn der Pfad an Position
	 * <code>pathIndex</code> die Länge 1 besitzt.
	 * 
	 * @param pathIndex
	 * @return <code>true</code>, wenn der Metapfad an Position
	 *         <code>pathIndex</code> die Länge 1 besitzt.
	 */
	public final boolean isImmediate(int pathIndex) {
	...
	/**
	 * Liefert die IDs der Assoziationstypen des Pfades an Position
	 * <code>pathIndex</code>
	 * 
	 * @param pathIndex
	 *            Index des Pfadschrittes
	 * @return IDs der Assoziationstypen des Pfades an Position
	 *         <code>pathIndex</code>
	 */
	public final Class<? extends Kante>[] getEdgeClasses(int pathIndex) {
	 ...
	 * @return
	 */
	public final Color getColor(int direction) {
	 ...
	 * @return
	 */
	public final String getDescription(int direction) {
