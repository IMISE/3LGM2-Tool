...
public class CleanModelDialog extends JDialog implements WindowListener{
	...
	/**
	 * Checkbox für die Option, inkonsistente Aufgabe-Orgnaisationseinheiten-Kombinationen zu löschen
	 */
	 ...
	 */
	private Checkbox[] boxes = {inconsistentAWBConfigsBox, 
	 ...
	 * @param owner
	 */
	private CleanModelDialog(Frame owner) {
	 ...
	 * @return
	 */
	private static final String getString(String resourceKey) {
	...
	private class HelpButton extends JButton{
		 ...
		 */
		public HelpButton(String dialogTitleKey, String helpTextKey) {
			super();
			...
			setAction(new AbstractAction(getString("help_icon")) {
				@Override
				public void actionPerformed(ActionEvent e) {
					JOptionPane.showMessageDialog(Tool3lgm.tool, 
								CleanModelDialog.getString(helpKey), 
								CleanModelDialog.getString(titleKey), 
