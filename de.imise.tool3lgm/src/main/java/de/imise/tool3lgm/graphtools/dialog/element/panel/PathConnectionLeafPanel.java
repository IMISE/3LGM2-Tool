...
public class PathConnectionLeafPanel extends PathConnectionPanel {
    ...
    public PathConnectionLeafPanel(final AbstractElementPropertyDialog dialog, final IMetaPath metaPath) {
        this(dialog, LABEL_END_ELEMENT_TYPE, LABEL_END_ELEMENT_TYPE, metaPath);
    }

    public PathConnectionLeafPanel(final AbstractElementPropertyDialog dialog, final PanelLabelOption titleLabelOption, final PanelLabelOption westLabelOption, final IMetaPath metaPath) {
        this(dialog, titleLabelOption, westLabelOption, -1, metaPath);
    }

    public PathConnectionLeafPanel(final AbstractElementPropertyDialog dialog, final int maxLines, final IMetaPath metaPath) {
        this(dialog, LABEL_END_ELEMENT_TYPE, LABEL_END_ELEMENT_TYPE, maxLines, metaPath);
    }

    public PathConnectionLeafPanel(final AbstractElementPropertyDialog dialog, final PanelLabelOption titleLabelOption, final PanelLabelOption westLabelOption, final int maxLines, final IMetaPath metaPath) {
