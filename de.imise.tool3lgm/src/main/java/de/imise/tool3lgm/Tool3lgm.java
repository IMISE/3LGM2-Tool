...
public class Tool3lgm {
    ...
    private File chooseModelFile(File file, final Object fileChooserPathKey) {
        ...
        if (fileChooserPathKey == null) {
            ...
            UserProperties.setDirectory(StringProperty.WORKING_DIRECTORY, currentDirectory);
        }
    ...
    void setSelectedDoc(final GraphDocument doc) {
        if (doc != null) {
            ...
            //die Collection des übergebenen doc als letzte in die Collection-Liste bringen
