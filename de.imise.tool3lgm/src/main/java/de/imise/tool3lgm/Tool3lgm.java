...
public class Tool3lgm extends JFrame implements	WindowListener, InternalFrameListener, GraphDocumentListener, TransactionListener {
	...
	private ModelBrowserPanel modelBrowserPanel;
	...
	/** alle GDCollections */
	private ArrayList<GDCollection> collections = new ArrayList<GDCollection>();
	 ...
	 * @param y
	 */
	public static final void setLastActionPosition(int x, int y) {
	 ...
	 * COMMENTME
	 */
	private Properties licenseItems = new Properties();
	 ...
	 */
	static boolean activateRMI(String args[], boolean visible) {
...
//		screenSize.width -= 50;
   ...
   /** 
    * Ermöglicht das Auslösen der {@link AbstractLGMAction#getKeyStrokeActions()}
   ...
   private static final void registerPublicKeyStrokes() {
	 ...
	 */	
	public static ContextGenerator getContextGenerator() {return contextGenerator;}
	 ...
	 * @return
	 */
	private boolean loadFile(File file, GDCollection gdcoll) {
		try {
			...
			JOptionPane.showOptionDialog(this, Tool3lgmConstants.getResString("oeffnenfehler") + "\n" + file.getPath() + "\n" + e.getMessage(), Tool3lgmConstants.getResString("tool3lgm"), JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, buttons, null);
			if(progressDialog != null)
				closeProgressDialog();
			return false;
		}
	 ...
	 */
	public boolean openFile(boolean open) {
	 ...
	 *            Option ist aber nue relevant, wenn <code>file</code> 
	 * 			  <code>null</code>
	 *            ist.
	 * @param file
	 ...
	 */
	public boolean openFile(boolean open, File file) {
...
*/		
	 ...
	 */
	public final void printStatistic(GDCollection gdc, boolean useElements, boolean alphabetic) {
...
*/
	 ...
	 * @return
	 */
	private AbstractInternalFrame createMainFrame(LGMGraphDocument maindoc) {
	 ...
	 * @return
	 */
	public AbstractInternalFrame createSzenarioFrame(Szenario szenario) {
	 ...
	 */		
	public boolean createTableInternalFrame(LGMGraphDocument _graphDocument) {
	...
	private int countFramesWithSameTitle(String title) {
    ...
    */
   public void setWorkArea(ToolInternalFrame frame) {
    ...
    *            to set
    */
	public void setWorkArea(ToolInternalFrame frame, ViewParameter view) {
		InputGraphArea bgp = frame.getInputGraphArea();
    ...
    */
	...
	/**
	 * Wechselt den Kontext auf das übergebene Teilmodell. In jedem Fall wird der <code>ModelBrowser</code>
	 * des aktivierten Teilmodells in den Vordergrund gebracht.
	 * @param doc
	 ...
	 */
	public void setSelectedDoc(GraphDocument doc, boolean activateGraphView) {
   ...
   /**
    * Je nach Paramter wir die Konsitenzprüfung bei <code>true</code> ein und bei <code>false</code> 
    * ausgeschaltet. Das beinhaltet auch das Anzeigen der Fehlertabelle.
    * 
	* @param state
   ...
   public void fensterNebeneinander()
   {
	 ...
	 * @return
	 */
	public AbstractInternalFrame findFirstInternalFrame(GraphDocument szen) {
	 ...
	 * @param szen
	 */
	public void closeFrame(GraphDocument szen) {
	...
	public void closeAllFramesAndTabs(GDCollection gdcoll) {
	 ...
	 * @return
	 */
	private boolean askUserCloseModel(GDCollection gdcoll){
		if (!gdcoll.isChanged())
			return true;
		Object[] buttons = new Object[] { Tool3lgmConstants.getResString("yes"), Tool3lgmConstants.getResString("no"), Tool3lgmConstants.getResString("cancel") };
...
//	   long start = System.currentTimeMillis();
	   ...
	   if (! checkLicenses()) {
		...
		File datei = gdCollection.getFile();
      	...
      	try {
      		if (!gdCollection.saveToFile()) return false;	
		} catch (Exception exp) {
...
*/
    ...
    */
	...
	/* (non-Javadoc)
	 * @see tool3lgm.graphtools.undoredo.TransactionListener#transactionStarted()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see tool3lgm.graphtools.undoredo.TransactionListener#transactionStopped()
	 */
	@Override
    ...
    * @return JPanel
    */
   public JPanel getWorkArea() {return workarea;}
   
   /**
    * return the verticalSplitPane of application
    * @return JSplitPane
    */
   public JSplitPane getVerticalSplitPane() {return verticalSplitPane;}
    ...
    * @return JSplitPane
    */
   public JSplitPane getHorizontalSplitPane() {return horizontalSplitPane;}

   /**
    * return the werkzeugleiste of application
    * @return UnfloatableToolBar
    */
   public UnfloatableToolBar getWerkzeugleiste() {return werkzeugleiste; }
	...
	*/
	public void showProgressDialog(JFrame owner) {
		closeProgressDialog();
	...
	*/
	public void showProgressDialog(JDialog owner) { 
		closeProgressDialog();
		progressDialog = new ProgressDialog(owner, true);
	}
	 ...
	 */
	public void setProgressDialogTitle(String text) {
	 ...
	 */
	public void setProgressDialogStatusLabel(String text) {
		if (progressDialog == null) return;
		progressDialog.setStatusLabelText(text);
	}
	
	/** (De-)Aktiviert den ModelBrowser */
	public void showModelBrowser(boolean b) {
		if(b) {
	 ...
	 */
	public GDCollection getCollection(int index) {
	 ...
	 * @param eventCode
	 */
	public void distributeOptionChange(int eventCode) {
	 ...
	 * @param doc
	 */
	public void changeToLinked(GraphDocument doc) {
		...
		if (frame != null) {
			if (hyperlink != null) {
				Object[] buttons = new Object[] { Tool3lgmConstants.getResString("hyperlink"), Tool3lgmConstants.getResString("submodel"), Tool3lgmConstants.getResString("cancel") };
	 ...
	 * @throws IOException
	 */
	private final String getLicenseError(File licenseFile) throws InvalidKeyException, NoSuchAlgorithmException, InvalidKeySpecException, SignatureException, IOException, SocketException {
	...
	public void processCommand(String command, String[] params) {
		...
		if (command == null) {
			...
			GraphDocument doc = this.getSelectedDoc().getCollection().getMainGraphDocument();
			if (doc == null)
				return;
