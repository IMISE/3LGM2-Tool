 ...
 */
public final class CommunicationLinkEdgeToApplicationComponentEdge extends Edge {

    public static final Class<? extends ModelElement> stcl = CommunicationLinkEdge.class;
