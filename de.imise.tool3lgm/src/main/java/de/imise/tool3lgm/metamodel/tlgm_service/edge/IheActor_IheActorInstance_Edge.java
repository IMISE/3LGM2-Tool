...
public class IheActor_IheActorInstance_Edge extends InstanciationEdge {
    ...
    static {
        addInstanciableMetaPath(IheActor_IheActorInstance_Edge.class,
                new SimpleMetaPathOld(IheActor.class, IheActorInstance.class, IheActor_IheInterface_Edge.class, IheInvokingInterface_InvokingInterface_Edge.class, ApplicationComponent_CommunicationInterface_Edge.class));
        addInstanciableMetaPath(IheActor_IheActorInstance_Edge.class,
                new SimpleMetaPathOld(IheActor.class, IheActorInstance.class, IheActor_IheInterface_Edge.class, IheProvidingInterface_ProvidingInterface_Edge.class, ApplicationComponent_CommunicationInterface_Edge.class));
    }
