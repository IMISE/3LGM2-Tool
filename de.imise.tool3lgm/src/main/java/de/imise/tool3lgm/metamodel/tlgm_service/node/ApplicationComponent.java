...
public abstract class ApplicationComponent extends Node {
    ...
    public ElementPropertyDialog createPropertyDialog() {
        ...
        dialog.addPathConnectionInfoPanel(SupportLink_Edge.class, Function_Use_Edge.class);
        ...
        dialog.addPathConnectionPanel(ApplicationComponent_SupportLink_Edge.class, OrganisationalUnit_SupportLink_Edge.class);
        dialog.addEdgePanel(ApplicationComponent_CommunicationInterface_Edge.class);
        return dialog;
    }
