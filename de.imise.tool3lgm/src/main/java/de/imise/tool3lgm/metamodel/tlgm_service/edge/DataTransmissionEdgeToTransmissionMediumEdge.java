 ...
 */
public final class DataTransmissionEdgeToTransmissionMediumEdge extends Edge {

    public static final Class<? extends ModelElement> stcl = DataTransmissionEdge.class;
