 ...
 */
public final class OrganisationSystem_HasPartEdge extends PartitioningEdge {

    public static final Class<? extends ModelElement> stcl = OrganisationSystem.class;

    public static final EdgeCardinality scard = ZERO_ONE;

    public static final EdgeCardinality ecard = ZERO_UNIMITED;

    public static final Class<? extends ModelElement> etcl = OrganisationSystem.class;
