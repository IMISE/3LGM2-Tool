...
public class LGMTreeNode extends DefaultMutableTreeNode {
	...
	private ArrayList<Object> userObjects = new ArrayList<Object>(1);
	 ...
	 * @param sort
	 */
	public LGMTreeNode(Object o, boolean setTreeNode, boolean sort) {
		super();
		userObjects.add(o);
	 ...
	 * @param setTreeNode
	 */
	public LGMTreeNode(Object o, boolean setTreeNode) {
	 ...
	 * @param sort
	 */
	public LGMTreeNode(Object o, String visibleText, boolean sort) {
		super();
		userObjects.add(o);
	...
	public String toString() {
		if (visibleText != null)
			return visibleText;
		// else if ((userObjects.size() == 0) || (userObjects.get(0) == null)) {
	 ...
	 * @param index
	 */
	public void setUserObject(Object o, int index) {
	 ...
	 * @param b
	 */
	public void setActionByDoubleClick(boolean b) {
