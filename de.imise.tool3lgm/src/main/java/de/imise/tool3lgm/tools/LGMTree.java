...
public class LGMTree extends JTree  {
	...
	public LGMTree(DefaultTreeModel treeModel, GraphDocument doc) {
		super(treeModel);
		this.doc = doc;
	...
	public LGMTree(DefaultTreeModel treeModel) {
		super(treeModel);
	}
	...
	public LGMTreeNode addObject(ElementContainer objekt, LGMTreeNode parent, ArrayList<ElementContainer> excludeChildren, boolean force, boolean childrenAreSelectable) {
		return addObject(objekt, parent, excludeChildren, force, true, childrenAreSelectable);
	}
	
	public LGMTreeNode addObject(ElementContainer objekt, LGMTreeNode parent, ArrayList<ElementContainer> excludeChildren, boolean force, boolean checkAlreadyAdded, boolean childrenAreSelectable) {
	...
	private void addChildren(LGMTreeNode elementNode, ArrayList<ElementContainer> excludeChildren, boolean checkAlreadyAdded, boolean childrenAreSelectable) {
	 ...
	 */
	private ArrayList<String> expandedPathStrings = new ArrayList<String>();
...
*/			
	 ...
	 */
	public void restoreSelection(LGMTree selectionSource) {
	 ...
	 */
	public void restoreSelectionAndScroll(LGMTree selectionSource) {
