...
<!--type: html -->
<!--description: extrahiert alle Anwendungsbausteine mit Namen, Beschreibungen, Softwareprodukten und Datenbankverwaltungssystemen -->
			...
			<xsl:otherwise>
				<table cellspacing="0" cellpadding="3" border="1">
					<tr>
						...
						<th><xsl:value-of select="'Beschreibung'" /></th>
