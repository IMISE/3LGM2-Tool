...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="header_text"
		select="'Welche Physischen Datenverarbeitungsbausteine geh&#246;ren zu welchem Bausteintyp? Eigenschaften der Physischen Datenverarbeitungsbausteine?'" />
	<xsl:variable name="cont_text" select="'Inhalt'" />
	<xsl:variable name="with_text"
		select="'Eigenschaften der Physischen Datenverarbeitungsbaustein mit Bausteintyp'" />
	<xsl:variable name="without_text"
		select="'Physischen Datenverarbeitungsbaustein ohne Bausteintyp'" />
