...
<!--name: Entity Types: Overview -->
<!--type: html -->
<!--description: extracts all entity types together with their names and descriptions -->
...
<xsl:variable name="zielobjekt" select="'Objekttyp'" />

<xsl:variable name="header_text" select="'Entity Type'" />
<xsl:variable name="name_text" select="'Name'" />
<xsl:variable name="desc_text" select="'Description'" />
