...
<xsl:variable name="auforgkomb_text" select="'Function-Organizational Unit Combination'" />
...
<xsl:variable name="rech_text" select="'Computer-based application component'" />
...
<html>
	...
	<body>
		<xsl:comment>This HTML file was generated automatically from a 3LGM file..</xsl:comment>
...
<!-- Knoten der logischen Werkzeugebene -->
	...
	<xsl:variable name="ETNTKombination" select="count(key('anzahlObjekte', 'EreignisNachrichtenTyp'))" />
	<xsl:variable name="ETDTKombination" select="count(key('anzahlObjekte', 'EreignisDokumentenTyp'))" />
