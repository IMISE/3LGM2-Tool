...
<!--type: html -->
<!--description: What functions are still supported by paper-based application components? For what functions are there different possibilites? -->
...
<xsl:variable name="header_text" select="'What functions are still supported by paper-based application components? For what functions are there different possibilites?'" />
