...
<!--name: Organizational Units: Overview -->
<!--type: html -->
<!--description: extracts all organizational units together with their names and descriptions from the model -->
...
<xsl:variable name="header_text" select="'Organizational Units'" />
