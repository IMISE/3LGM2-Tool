...
<html>
	...
	<body>
		...
		<table border="1" cellpadding="4" cellspacing="0">
			<tr><th>Communication Standard</th><!--<th>Component Interfaces</th>--><th>Existing connections</th><th>Possible connections</th></tr>
		...
		<xsl:if test="key('ETNTKOM',key('KOMBEZETNT',@hash)/child::field[@name='end'])/child::field[@name='end'] = $KOM
		 and key('KOMBSS',child::field[@name='start'])/child::field[@name='end'] = $KOM and key('KOMBSS',child::field[@name='end'])/child::field[@name='end'] = $KOM">
		  <!--and key('KOMBEZETNT',@hash)/child::field[@name='end'] = key('BSSETNT',child::field[@name='start'])/child::field[@name='end'] and key('KOMBEZETNT',@hash)/child::field[@name='start'] = key('BSSETNT',child::field[@name='start'])/child::field[@name='end'] ">-->
			...
			<xsl:value-of select="key('hash',key('AWBKOM',child::field[@name='start'])/child::field[@name='start'])/child::field[@name='name']"/>
			<xsl:text> (</xsl:text><xsl:value-of select="key('hash',key('SW',key('AWP',key('AWBKOM',child::field[@name='start'])/child::field[@name='start'])/child::field[@name='end'])/child::field[@name='end'])/child::field[@name='name']" /><xsl:text>) </xsl:text>
			...
			<xsl:value-of select="key('hash',key('AWBKOM',child::field[@name='end'])/child::field[@name='start'])/child::field[@name='name']"/>
			<xsl:text> (</xsl:text><xsl:value-of select="key('hash',key('SW',key('AWP',key('AWBKOM',child::field[@name='end'])/child::field[@name='start'])/child::field[@name='end'])/child::field[@name='end'])/child::field[@name='name']" /><xsl:text>) </xsl:text><br/><br/>
		</xsl:if>
	</xsl:for-each>
</xsl:template>
