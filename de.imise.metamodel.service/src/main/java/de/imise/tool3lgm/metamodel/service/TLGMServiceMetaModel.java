...
public class TLGMServiceMetaModel extends MetaModelDefinition implements RegularMetaModelDefinition {
    ...
    protected void addRemovedEdgeClasses() {
        ...
        addRemovedEdgeClassesForStartAndEndClass(IheActorInstance.class, PartableApplicationComponent_HasPartEdge.class);//darf kein Teilelement sein und selbst nicht in Teile zerlegbar sein
