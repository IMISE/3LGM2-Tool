...
import static de.imise.tool3lgm.graphtools.dialog.element.panel.PanelLabelOption.LABEL_LAST_EDGE_ELEMENT_NAME;
...
public abstract class ApplicationComponent extends Node {
    ...
    public ElementPropertyDialog createPropertyDialog() {
        ...
        //HIER nicht bis zu den Objekttypen gehen, weil man sonst keine vorhdandenen Repräsentationsformen auswählen kann
        dialog.addPathConnectionPanel(LABEL_LAST_EDGE_ELEMENT_NAME, LABEL_LAST_EDGE_CONNECTION_NAME_WITH_CONNECTED_ELEMENT_TYPE, ApplicationComponent_RepresentationForm_Edge.class);
