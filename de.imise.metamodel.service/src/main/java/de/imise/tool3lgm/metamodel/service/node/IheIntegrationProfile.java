...
public class IheIntegrationProfile extends Node {
    ...
    public ElementPropertyDialog createPropertyDialog() {
        ...
        dialog.addTablePanel(tableDefinition, 2, IheIntegrationProfile_IheActor_Edge.class, IheActor_IheInterface_Edge.class, IheInterface_IheTransaction_Edge.class);
