...
public class ProvidingInterface extends CommunicationInterface {
    ...
    public ElementPropertyDialog createPropertyDialog() {
        ...
        dialog.addPathConnectionPanel(Service_ProvidingInterface_Edge.class, Service_RepresentationForm_Edge.class, ObjectType_RepresentationForm_Edge.class);
        ...
        //aber geht -> keine Tabelle (dasselbe beim InvokingInterface)
