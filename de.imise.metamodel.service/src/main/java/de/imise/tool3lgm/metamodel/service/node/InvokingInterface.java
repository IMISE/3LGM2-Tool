 ...
 */
public class InvokingInterface extends CommunicationInterface {
    ...
    public ElementPropertyDialog createPropertyDialog() {
        ...
        dialog.addPathConnectionPanel(Service_InvokingInterface_Edge.class, Service_RepresentationForm_Edge.class, ObjectType_RepresentationForm_Edge.class);
        //Die folgende Tabelle ergibt nicht viel Sinn, da sie im Grunde nur dasselbe darstellt,
        //wie ein PathConnectionPanel mit demselben MetaPfad, man aber üner die Tabelle keine
        //Objekttypen zu bestehenden Repsäsentaionsformen zurodnen kann, was über das PathConnectionPanel
        //aber geht -> keine Tabelle (dasselbe beim ProvidingInterface)
        ...
        //        dialog.addTablePanel(tableDefinition, 0, Service_InvokingInterface_Edge.class, Service_RepresentationForm_Edge.class, ObjectType_RepresentationForm_Edge.class);
