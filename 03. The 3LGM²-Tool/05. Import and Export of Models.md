...
You can export via XSLT after selecting the menu *File > Export > Export via XSLT...*. With the help of XSLT you have the possibility to export a whole model or single submodels into different formats. Currently, this function is used to convert 3LGM² models into HTML descriptions that can be viewed in a browser. The XSLT scripts required for this are available in the 3LGM²-Tool.
...
|----------------|-----------------|--------------|
| [Analysis of 3LGM² models](04. Analysis of 3LGM² models) | [The 3LGM² Tool](https://bitbucket.org/imise/tool-3lgm2/wiki/03.%20The%203LGM%C2%B2-Tool) | [Userfields and Subtypes](06. Userfields and Subtypes) |
