...
In our example in Fig. 4 there are two alternative configurations for the WARD application component. If the PDPC (Physical Data Processing Component) WARD PC1 fails, configuration 1 cannot be used, but configuration 2 can be used. If the PDPC DB server fails, no configuration can be used.

--------------------------------

|Previous chapter| Navigation Page | Next chapter |
|----------------|-----------------|--------------|
| [Physical Tool Layer](03. Physical Tool Layer) | [3LGM² Metamodel](https://bitbucket.org/imise/tool-3lgm2/wiki/02.%203LGM%C2%B2%20Metamodel) | [Coarsening and Refining](05. Coarsening and Refining) |
