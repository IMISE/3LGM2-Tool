...
![analysisMenuBar.PNG](/images/firststeps/analysisMenuBar.PNG)

### **1. Repository** ###
This opens following window:

![analysisRepository.PNG](/images/firststeps/analysisRepository.PNG)
...
![analysisRightClickOption.PNG](/images/firststeps/analysisRightClickOption.PNG)
...
![analysisResults1.PNG](/images/firststeps/analysisResults1.PNG)
...
![analysisResultsShowConf.PNG](/images/firststeps/analysisResultsShowConf.PNG)

![analysisResults2.PNG](/images/firststeps/analysisResults2.PNG)

**To reset the results** you can click the **Reset Results** option by going to **Analysis** in the menu bar.

![analysisResetResults.PNG](/images/firststeps/analysisResetResults.PNG)

### **Editor** ###
You can define your own analysis options. To do this, choose the **Editor** in the analysis tab.

![analysisTabEditor.PNG](/images/firststeps/analysisTabEditor.PNG)

This will open following window:

![analysisEditorClean.PNG](/images/firststeps/analysisEditorClean.PNG)
...
![analysisEditor.PNG](/images/firststeps/analysisEditor.PNG)

### **Redundancy Analysis** ###
Furthermore you have the options to do certain redundancy analysis.

![analysisTabRedundancy.PNG](/images/firststeps/analysisTabRedundancy.PNG)
...
![redundancyAnalysisFunction.PNG](/images/firststeps/redundancyAnalysisFunction.PNG)
...
![redundancyAnalysisEntity.PNG](/images/firststeps/redundancyAnalysisEntity.PNG)
