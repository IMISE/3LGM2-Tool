...
![analysisMenuBar.PNG](/public/images/firststeps/analysisMenuBar.PNG)

### **1. Repository** ###
This opens following window:

![analysisRepository.PNG](/public/images/firststeps/analysisRepository.PNG)
...
![analysisRightClickOption.PNG](/public/images/firststeps/analysisRightClickOption.PNG)
...
![analysisResults1.PNG](/public/images/firststeps/analysisResults1.PNG)
...
![analysisResultsShowConf.PNG](/public/images/firststeps/analysisResultsShowConf.PNG)

![analysisResults2.PNG](/public/images/firststeps/analysisResults2.PNG)

**To reset the results** you can click the **Reset Results** option by going to **Analysis** in the menu bar.

![analysisResetResults.PNG](/public/images/firststeps/analysisResetResults.PNG)

### **Editor** ###
You can define your own analysis options. To do this, choose the **Editor** in the analysis tab.

![analysisTabEditor.PNG](/public/images/firststeps/analysisTabEditor.PNG)

This will open following window:

![analysisEditorClean.PNG](/public/images/firststeps/analysisEditorClean.PNG)
...
![analysisEditor.PNG](/public/images/firststeps/analysisEditor.PNG)

### **Redundancy Analysis** ###
Furthermore you have the options to do certain redundancy analysis.

![analysisTabRedundancy.PNG](/public/images/firststeps/analysisTabRedundancy.PNG)
...
![redundancyAnalysisFunction.PNG](/public/images/firststeps/redundancyAnalysisFunction.PNG)
...
![redundancyAnalysisEntity.PNG](/public/images/firststeps/redundancyAnalysisEntity.PNG)
...
|----------------|-----------------|--------------|
| [The Matrix-View](/03.%20The%203LGM%C2%B2-Tool/03.%20The%20Matrix-View) | [The 3LGM²-Tool](/03.%20The%203LGM%C2%B2-Tool) | [Import and Export of Models](/03.%20The%203LGM%C2%B2-Tool/05.%20Import%20and%20Export%20of%20Models) |
