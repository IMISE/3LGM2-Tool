...
![ExampleModel.PNG](/public/images/firststeps/ExampleModel.PNG)
...
![ModelSelection.PNG](/public/images/firststeps/ModelSelection.PNG)
...
![SubmodelTab.PNG](/public/images/firststeps/SubmodelTab.PNG)
...
![SingleLayerSelection.PNG](/public/images/firststeps/SingleLayerSelection.PNG)

 and then select the domain layer (DL button in the standard toolbar).

![DomainLayerSelection.PNG](/public/images/firststeps/DomainLayerSelection.PNG)

The Document window will now display only the domain layer. 

If you now expand the domain layer in the Model Browser and then select Function, you will see the functions displayed in the Document window. Functions can be superordinate or subordinate to other functions. In the model browser, subordinate functions are only displayed when you expand the parent function in the model browser. The same is true for all other elements in the 3LGM²-Tool that can be super- or subordinate.

![functionsModelBrowser.PNG](/public/images/firststeps/functionsModelBrowser.PNG)
...
If you want to view or change the properties of a model element, double-click on the corresponding element in the Model Browser or right-click on the element in the document window and select Properties from the context menu that appears.
...
![Multiview.PNG](/public/images/firststeps/Multiview.PNG)
...
![ShowInterlayer.PNG](/public/images/firststeps/ShowInterlayer.PNG)
...
|----------------|-----------------|--------------|
| [Create, open and save models](/01.%20First%20steps/02.%20Create,%20open%20and%20save%20models) | [First steps](/01.%20First%20steps) | [Adding elements](/01.%20First%20steps/04.%20Adding%20elements) |
