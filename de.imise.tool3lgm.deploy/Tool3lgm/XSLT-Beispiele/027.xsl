...
<!--name: Kommunikation von Objekttypen -->
<!--type: html -->
...
<xsl:template match="modell_3lgm_2/objects/element[@class='Objekttyp']">
	<tr><td><xsl:attribute name="colspan">4</xsl:attribute><h4><xsl:attribute name="style">margin-top:10pt; margin-bottom:0pt;</xsl:attribute><xsl:value-of select="str:removeLineBreak(child::field[@name='name'])" /></h4></td></tr>
...
<xsl:template name="ausgabe">
	...
	<tr><td></td>
		<td><xsl:value-of select="str:removeLineBreak(key('hash', key('kanteAnwBau' ,$sender)/child::field[@name='start'])/child::field[@name='name'])" /></td>
