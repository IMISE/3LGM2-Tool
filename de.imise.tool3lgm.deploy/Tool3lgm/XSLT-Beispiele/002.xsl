...
<!--name: alle Objekttypen -->
<!--type: html -->
<!--description: extrahiert alle Objekttypen mit Namen aus einem Modell -->
<!--author: Thomas Rudert 08.08.2003 -->
...
<xsl:variable name="header_text" select="'Objekttypen'" />
