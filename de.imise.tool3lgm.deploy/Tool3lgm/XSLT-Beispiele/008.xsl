...
<!--name: alle Bausteinschnittstellen -->
<!--type: html -->
<!--description: extrahiert alle Bausteinschnittstellen mit Namen und Beschreibung aus einem Modell -->
...
<xsl:variable name="zielobjekt" select="'Bausteinschnittstelle'" />
<xsl:variable name="header_text" select="'Bausteinschnittstellen'" />
<xsl:variable name="name_text" select="'Bezeichung'" />
...
<html>
	...
	<body>
		...
		<table cellspacing="0" cellpadding="3" border="1">
			<tr><th><xsl:value-of select="$name_text" /></th><th><xsl:value-of select="$desc_text" /></th></tr>
