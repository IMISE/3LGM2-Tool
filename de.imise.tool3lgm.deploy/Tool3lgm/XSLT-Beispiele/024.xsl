...
<!--type: html -->
<!--description: Welche Aufgaben werden in welchen Organisationseinheiten durch welche Anwendungsbausteine erledigt (Variante 1)? (Teilaufgaben mit in uebergeordnete Aufgaben einbeziehen) -->
